<?php if(Auth::user() != null): ?>
    ...
    <div class="quixnav">
        <a href="<?php echo e($base_url); ?>/admin/dashboard" class="quixnav-logo">
            <img src="<?php echo e($base_url); ?>/login-images/logo.png" alt="KanooX">
        </a>
        <div class="quixnav-scroll">
            <ul class="metismenu" id="menu">

                <?php if($my_permissions->contains('DASHBOARD')): ?>

                    <li class="<?php echo e(request()->is('admin/dashboard') ? 'page-active' : ''); ?>">
                        <a href="<?php echo e($base_url); ?>/admin/dashboard" aria-expanded="false">
                            <i class="fa fa-tachometer" aria-hidden="true"></i>
                            <span class="nav-text">Dashboard</span>
                        </a>
                    </li>
                <?php endif; ?>
                <!-- <?php if($my_permissions->contains('ROLE_ALL')): ?>
                    <li><a href="<?php echo e($base_url); ?>/admin/role/all" aria-expanded="false"><i
                                class="fa-solid fa-person-circle-question"></i><span class="nav-text">Roles</span></a></li>
                <?php endif; ?> -->
                <?php if($my_permissions->contains('SERVICE_ALL')): ?>
                    <li
                        class="<?php echo e(request()->is('admin/service/*') || request()->is('admin/sub-services/*') ? 'page-active' : ''); ?>">
                        ...
                        <ul aria-expanded="false">
                            <li class="<?php echo e(request()->is('admin/service/*') ? 'active' : ''); ?>"><a
                                    href="<?php echo e($base_url); ?>/admin/service/all">Services</a></li>
                            <li class="<?php echo e(request()->is('admin/sub-services/*') ? 'active' : ''); ?>"><a
                                    href="<?php echo e($base_url); ?>/admin/sub-services/all">Sub-Services</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if($my_permissions->contains('BANK_ALL')): ?>
                    <li class="<?php echo e(request()->is('admin/bank/*') ? 'page-active' : ''); ?>">
                        <a href="<?php echo e($base_url); ?>/admin/bank/all" aria-expanded="false"><i
                                class="fa-solid fa-chart-simple"></i><span class="nav-text">Banks</span></a>
                    </li>
                <?php endif; ?>

                <?php if($my_permissions->contains('SETTING')): ?>
                    <li
                        class="<?php echo e(request()->routeIs('admin.loan.services') || request()->routeIs('admin.blogs.*') ? 'page-active' : ''); ?>">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa-solid fa-gear"></i><span class="nav-text">Settings</span></a>
                        <ul aria-expanded="false">
                            <?php if($my_permissions->contains('LOAN_SERVICES')): ?>
                                <li class="<?php echo e(request()->routeIs('admin.loan.services') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.loan.services')); ?>" aria-expanded="false">
                                        <span class="nav-text">Loan Services</span>
                                    </a>
                                </li>
                            <?php endif; ?>
                            <?php if($my_permissions->contains('BLOGS')): ?>
                                <li class="<?php echo e(request()->routeIs('admin.blogs.*') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.blogs.index')); ?>" aria-expanded="false">
                ...
                <?php endif; ?>
                <?php if($my_permissions->contains('REPORT')): ?>
                    <li
                        class="<?php echo e(request()->routeIs('admin.user.journey.report') || request()->routeIs('admin.cibil.reports') || request()->routeIs('admin.loan.leads') || request()->routeIs('admin.credit-cards.leads') || request()->is('admin/user-contacts') ? 'page-active' : ''); ?>">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa-solid fa-table"></i><span class="nav-text">Reports</span></a>
                        <ul aria-expanded="false">
                            <?php if($my_permissions->contains('BANK_CLICK')): ?>
                                <li class="<?php echo e(request()->routeIs('admin.user.journey.report') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.user.journey.report')); ?>"><span class="nav-text">User Journey
                                            Report</span></a>
                                </li>
                            <?php endif; ?>
                            <?php if($my_permissions->contains('CIBIL_REPORT_VIEW')): ?>
                                <li class="<?php echo e(request()->routeIs('admin.cibil.reports') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.cibil.reports')); ?>"><span class="nav-text">CIBIL Reports</span></a>
                                </li>
                            <?php endif; ?>
                            <?php if($my_permissions->contains('LOAN_REPORT')): ?>
                                <li class="<?php echo e(request()->routeIs('admin.loan.leads') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.loan.leads')); ?>"><span class="nav-text">Loan Leads</span></a>
                                </li>
                            <?php endif; ?>
                            <?php if($my_permissions->contains('CREDIT_CARD_LEAD_VIEW')): ?>
                                <li class="<?php echo e(request()->routeIs('admin.credit-cards.leads') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('admin.credit-cards.leads')); ?>"><span class="nav-text">Credit Card
                                            Leads</span></a>
                                </li>
                            <?php endif; ?>
                            <?php if($my_permissions->contains('CONTACT_US_VIEW')): ?>
                                <li class="<?php echo e(request()->is('admin/user-contacts') ? 'active' : ''); ?>">
                                    <a href="<?php echo e($base_url); ?>/admin/user-contacts"><span class="nav-text">Contact Us</span></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
...
<script src="<?php echo e($base_url); ?>/js/custom.min.js"></script><?php /**PATH F:\xampp\htdocs\kanoo_partner\resources\views/layouts/left-menu.blade.php ENDPATH**/ ?>