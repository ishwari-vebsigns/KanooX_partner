            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="<?php echo e($base_url); ?>/admin/service/all">Services</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                 ...
                 <P></P>              <h4 class="card-title">
                    <?php if($my_permissions->contains('SERVICE_ADD')): ?>
                    <a href="add" style="color:white;" class="btn btn-secondary">Add Service</a>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\kanoo_partner\resources\views/services/all.blade.php ENDPATH**/ ?>