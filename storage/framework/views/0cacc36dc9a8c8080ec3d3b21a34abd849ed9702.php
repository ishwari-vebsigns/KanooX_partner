                                            ...
                                            <div class="col-xl-10">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?>">
                                                        <input type="text" class="form-control" value="<?php echo e(old('bank_name')); ?>" id="bank_name" name="bank_name" placeholder="Bank Name" required>
...
<div class="form-group row">
  ...
  <div class="col-lg-6">
    <input type="text"
           ...
           value="<?php echo e(old('effective_interest_range')); ?>"
...
<div class="form-group row">
  ...
  <div class="col-lg-6">
    <input type="text"
           class="form-control"
           name="age_limit"
           value="<?php echo e(old('age_limit')); ?>"
           ...
           required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <textarea class="form-control" id="val-suggestions" name="desc" rows="5" placeholder="What would you like to see?"><?php echo e(old('desc')); ?></textarea>
    ...
    <textarea
        ...
        class="form-control"
        rows="6"
    ><?php echo e(old('know_more_description')); ?></textarea>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\kanoo_partner\resources\views/bank/add.blade.php ENDPATH**/ ?>