...
<html lang="en">
  <head>
   <style>
    ...
    <title>KanooX</title>
    <link rel="icon" type="image/png" href="<?php echo e($base_url); ?>/login-images/favicon.png">
  ...
  <body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <div id="root" class="fullscreen-bg" style="background-image:url(<?php echo e($base_url); ?>/login-images/admin-img2.png);" x-cloak="">
...
$message = $__bag->first($__errorArgs[0]); ?>
         <center><span class="error-message"><?php echo e($message); ?></span></center>
         <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        <div class="card mt-5 rounded-lg p-5 lg:p-7">
          ...
          <div class="mt-4 flex items-center justify-between space-x-2">
            ...
            <!-- <a href="<?php echo e($base_url); ?>/password/reset" class="text-xs text-slate-400 transition-colors line-clamp-1 hover:text-slate-800 focus:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100 dark:focus:text-navy-100">Forgot Password?</a> -->
          </div>
          ...
          <div class="mt-4 text-center text-xs+">
            <!-- <p class="line-clamp-1">
              ...
              <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="<?php echo e($base_url); ?>\register-agent">Create account</a>
            </p> -->
          </div>
        </div>
...
</html><?php /**PATH F:\xampp\htdocs\kanoo_partner\resources\views/auth/login.blade.php ENDPATH**/ ?>