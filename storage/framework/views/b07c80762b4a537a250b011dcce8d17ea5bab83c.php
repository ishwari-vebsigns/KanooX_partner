            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="<?php echo e($base_url); ?>/admin/sub-services/all">Sub-Services</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                 ...
                 <P></P>              <h4 class="card-title">
                    <?php if($my_permissions->contains('SUBSERVICE_ADD')): ?>
                    <a href="add" style="color:white;" class="btn btn-secondary">Add Sub Service</a>
                    <?php endif; ?>
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    <?php if($my_permissions->contains('SERVICE_DETAILS')): ?>
                        return '<a type="button" href="edit/' + data.service_id + '" class="btn btn-dark">Details</a>'
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\kanoo_partner\resources\views/sub-services/all.blade.php ENDPATH**/ ?>