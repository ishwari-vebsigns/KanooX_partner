                ...
                <div class="col-12">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <form method="GET" action="<?php echo e(route('admin.cibil.reports')); ?>">
                                ...
                                <div class="row align-items-end g-3">
                                    ...
                                    <div class="col-md-2">
                                        <a href="<?php echo e(route('admin.cibil.reports')); ?>" class="btn btn-secondary w-100" style="background-color: #9D3895;">
                                            Clear
                                        </a>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <a href="<?php echo e(route('admin.cibil.export', request()->all())); ?>" class="btn btn-success">
                                    Export Excel
                                </a>
                            </div>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo e(\Carbon\Carbon::parse($r->created_at)->format('d M Y, h:i A')); ?>

                                                </td>

                                                <!-- ACTION -->
                                                <td class="text-center">
                                                    <a href="<?php echo e(route('admin.cibil.details', $r->id)); ?>" class="btn btn-details">
                                                        Details
                                                    </a>

                                                    <?php if($r->pdf_link): ?>
                                                        <a href="<?php echo e($r->pdf_link); ?>" target="_blank" class="btn btn-pdf">
                                                            PDF
                                                        </a>
                                                    <?php endif; ?>
                                                </td>
                            ...
                            <div class="mt-3">
                                <?php echo e($reports->appends(request()->only('search'))->links()); ?>
...
<?php echo $__env->make('layouts.admin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\kanoo_partner\resources\views/admin/cibil/index.blade.php ENDPATH**/ ?>