! function(t, e) {
            ...
            labels: {
                generateLabels: function(t) {
                    ...
                    return e.labels.length && e.datasets.length ? e.labels.map(function(i, n) {
                        ...
                        return {
                            text: i,
                            fillStyle: Kt([s.backgroundColor, o.backgroundColor, l.backgroundColor], void 0, n),
                            strokeStyle: Kt([s.borderColor, o.borderColor, l.borderColor], void 0, n),
                            lineWidth: Kt([s.borderWidth, o.borderWidth, l.borderWidth], void 0, n),
    ...
    var ie = Mt.extend({
            ...
            updateBezierControlPoints: function() {
                ...
                if (a.options.elements.line.capBezierPoints)
                    for (t = 0, e = l.length; t < e; ++t) i = l[t]._model, te(i, s) && (t > 0 && te(l[t - 1]._model, s) && (i.controlPointPreviousX = d(i.controlPointPreviousX, s.left, s.right), i.controlPointPreviousY = d(i.controlPointPreviousY, s.top, s.bottom)), t < l.length - 1 && te(l[t + 1]._model, s) && (i.controlPointNextX = d(i.controlPointNextX, s.left, s.right), i.controlPointNextY = d(i.controlPointNextY, s.top, s.bottom)))
            },
            draw: function() {
                var t, e = this.chart,
                    i = this.getMeta(),
            ...
            labels: {
                generateLabels: function(t) {
                    ...
                    return e.labels.length && e.datasets.length ? e.labels.map(function(i, n) {
                        ...
                        return {
                            text: i,
                            fillStyle: ne([r.backgroundColor, o.backgroundColor, s.backgroundColor], void 0, n),
                            strokeStyle: ne([r.borderColor, o.borderColor, s.borderColor], void 0, n),
                            lineWidth: ne([r.borderWidth, o.borderWidth, s.borderWidth], void 0, n),
                            hidden: isNaN(o.data[n]) || a.data[n].hidden,
                            index: n
                        }
                    }) : []
    ...
    var ye, ke = {
            ...
            update: function(t, e, i) {
                if (t) {
                    ...
                    }(v), ut.each(p, T), xe(p, M), ut.each(m, T), xe(m, M), ut.each(p, function(t) {
    ...
    function Te(t, e, i) {
        t.addEventListener(e, i, De)
    }

    function Fe(t, e, i) {
        t.removeEventListener(e, i, De)
    }

    function Le(t, e, i, n, a) {
        return {
            type: t,
            chart: e,
            native: a || null,
    ...
    var Oe = {
        ...
        _ensureLoaded: function() {
            var t, e;
            this._loaded || (this._loaded = !0, this.disableCSSInjection || (t = we, e = this._style || document.createElement("style"), this._style || (this._style = e, t = "/* Chart.js */\n" + t, e.setAttribute("type", "text/css"), document.getElementsByTagName("head")[0].appendChild(e)), e.appendChild(document.createTextNode(t))))
        },
        ...
        addEventListener: function(t, e, i) {
            ...
            if ("resize" !== e) {
                var a = i[Me] || (i[Me] = {});
                Te(n, e, (a.proxies || (a.proxies = {}))[t.id + "_" + e] = function(e) {
                    i(function(t, e) {
                        var i = Ie[t.type] || t.type,
                            n = ut.getRelativePosition(t, e);
                        return Le(i, e, n.x, n.y, t)
                    }(e, t))
                })
            } else ! function(t, e, i) {
                var n, a, o, r, s = t[Me] || (t[Me] = {}),
                    l = s.resizer = function(t) {
                        ...
                        if (s.resizer) {
                            var n = i.options.maintainAspectRatio && t.parentNode,
                                a = n ? n.clientWidth : 0;
                            e(Le("resize", i)), n && n.clientWidth < a && i.canvas && e(Le("resize", i))
                        }
                    }, o = !1, r = [], function() {
                ...
                ! function(t, e) {
                    ...
                    ut.each(Pe, function(e) {
                        Te(t, e, n)
                    }), i.reflow = !!t.offsetParent, t.classList.add(Ce)
                }(t, function() {
                    if (s.resizer) {
                        var e = t.parentNode;
    ...
    ut.addEvent = Te, ut.removeEvent = Fe;
    ...
    var Xe = pt.extend({
            ...
            getTitle: function() {
                var t = this._options.callbacks,
                    ...
                    a = [];
                return a = He(a, je(e)), a = He(a, je(i)), He(a, je(n))
            },
            ...
            getBody: function(t, e) {
                ...
                return ut.each(t, function(t) {
                    ...
                    He(o.before, je(n.beforeLabel.call(i, t, e))), He(o.lines, n.label.call(i, t, e)), He(o.after, je(n.afterLabel.call(i, t, e))), a.push(o)
                }), a
            },
            ...
            update: function(t) {
                ...
                if (p.length) {
                    ...
                    var k = [],
                        w = [];
                    y = Ee[c.position].call(h, p, h._eventPosition);
                    var M = [];
                    for (e = 0, i = p.length; e < i; ++e) M.push((a = void 0, o = void 0, void 0, void 0, l = void 0, d = void 0, u = void 0, a = (n = p[e])._xScale, o = n._yScale || n._scale, r = n._index, s = n._datasetIndex, d = (l = n._chart.getDatasetMeta(s).controller)._getIndexScale(), u = l._getValueScale(), {
                    ...
                    }), g.title = h.getTitle(M, m), g.beforeBody = h.getBeforeBody(M, m), g.body = h.getBody(M, m), g.afterBody = h.getAfterBody(M, m), g.footer = h.getFooter(M, m), g.x = y.x, g.y = y.y, g.caretPadding = c.caretPadding, g.labelColors = k, g.labelTextColors = w, g.dataPoints = M, b = function(t, e, i, n) {
                        var a = t.x,
                            o = t.y,
                            r = t.caretSize,
                            s = t.caretPadding,
            ...
            drawBody: function(t, e, i) {
                var n, a = e.bodyFontSize,
                    ...
                    u = 0,
                    h = l ? Ye(e, "left") : 0;
                i.textAlign = r, i.textBaseline = "top", i.font = ut.fontString(a, e._bodyFontStyle, e._bodyFontFamily), t.x = Ye(e, r);
                var c = function(e) {
            ...
            drawFooter: function(t, e, i) {
                var n = e.footer;
                n.length && (t.x = Ye(e, e._footerAlign), t.y += e.footerMarginTop, i.textAlign = e._footerAlign, i.textBaseline = "top", i.fillStyle = e.footerFontColor, i.font = ut.fontString(e.footerFontSize, e._footerFontStyle, e._footerFontFamily), ut.each(n, function(n) {
    ...
    ut.extend(ti.prototype, {
        construct: function(t, e) {
            ...
            e = function(t) {
                ...
                return e.datasets = e.datasets || [], e.labels = e.labels || [], t.options = Je(st.global, st[t.type], t.options || {}), t
            }(e);
            var n = Be.acquireContext(t, e),
                a = n && n.canvas,
                o = a && a.height,
                r = a && a.width;
            i.id = ut.uid(), i.ctx = n, i.canvas = a, i.config = e, i.width = r, i.height = o, i.aspectRatio = o ? r / o : null, i.options = e.options, i._bufferedRender = !1, i.chart = i, i.controller = i, ti.instances[i.id] = i, Object.defineProperty(i, "data", {
                get: function() {
        ...
        buildOrUpdateScales: function() {
            ...
            e.scales && (n = n.concat((e.scales.xAxes || []).map(function(t) {
                ...
                var n = e.options,
                    o = n.id,
                    r = Ze(n.type, e.dtype);
                Qe(n.position) !== Qe(e.dposition) && (n.position = e.dposition), a[o] = !0;
                var s = null;
                if (o in i && i[o].type === r)(s = i[o]).options = n, s.ctx = t.ctx, s.chart = t;
                else {
                    var l = We.getScaleConstructor(r);
                    if (!l) return;
                    s = new l({
                        id: o,
                        type: r,
                ...
                t || delete i[e]
            }), t.scales = i, We.addScalesToLayout(this)
        },
        ...
        bindEvents: function() {
            ...
            ut.each(t.options.events, function(n) {
                Be.addEventListener(t, n, i), e[n] = i
            }), t.options.responsive && (i = function() {
                t.resize()
            }, Be.addEventListener(t, "resize", i), e.resize = i)
        },
        unbindEvents: function() {
            var t = this,
                e = t._listeners;
            e && (delete t._listeners, ut.each(e, function(e, i) {
                Be.removeEventListener(t, i, e)
            }))
        },
    ...
    ti.Controller = ti, ti.types = {}, ut.configMerge = Je, ut.scaleMerge = $e, ut.extend(ni.prototype, {
        formats: ii,
        parse: ii,
        format: ii,
        add: ii,
            ...
            fit: function() {
                ...
                if (a.display && s) {
                    ...
                    if (t._maxLabelLines = v, t.longestLabelWidth = m, d) {
                        ...
                        var M, _, C = di(t.ctx, i[0], h.string),
            ...
            draw: function(t) {
                ...
                if (e._isVisible()) {
                    var n, a, o, r = e.chart,
                        ...
                        T = [],
                        F = h.drawBorder ? si(h.lineWidth, 0, 0) : 0,
                        L = ut._alignPixel;
                    if ("top" === f ? (n = L(r, e.bottom, F), a = e.bottom - S, o = n - F / 2) : "bottom" === f ? (n = L(r, e.top, F), a = n + F / 2, o = e.top + S) : "left" === f ? (n = L(r, e.right, F), a = e.right - S, o = n - F / 2) : (n = L(r, e.left, F), a = n + F / 2, o = e.left + S), ut.each(b, function(n, s) {
                            if (!ut.isNullOrUndef(n.label)) {
                                var l, d, u, c, v, b, x, y, w, M, P, I, A, R, O, z, B = n.label;
                                s === e.zeroLineIndex && i.offset === h.offsetGridLines ? (l = h.zeroLineWidth, d = h.zeroLineColor, u = h.zeroLineBorderDash || [], c = h.zeroLineBorderDashOffset || 0) : (l = si(h.lineWidth, s), d = si(h.color, s), u = h.borderDash || [], c = h.borderDashOffset || 0);
                    ...
                    if (F) {
                        var W, V, E, H, j = F,
                            q = si(h.lineWidth, b.length - 1, 0);
                        m ? (W = L(r, e.left, j) - j / 2, V = L(r, e.right, q) + q / 2, E = H = n) : (E = L(r, e.top, j) - j / 2, H = L(r, e.bottom, q) + q / 2, W = V = n), s.lineWidth = F, s.strokeStyle = si(h.color, 0), s.beginPath(), s.moveTo(W, E), s.lineTo(V, H), s.stroke()
                    }
                }
            }
        }),
    ...
    var ki = ui.extend({
            ...
            handleTickRangeOptions: function() {
                var t = this,
                    e = t.options.ticks;
                t.min = yi(e.min, t.min), t.max = yi(e.max, t.max), t.min === t.max && (0 !== t.min && null !== t.min ? (t.min = Math.pow(10, Math.floor(ut.log10(t.min)) - 1), t.max = Math.pow(10, Math.floor(ut.log10(t.max)) + 1)) : (t.min = 1, t.max = 10)), null === t.min && (t.min = Math.pow(10, Math.floor(ut.log10(t.max)) - 1)), null === t.max && (t.max = 0 !== t.min ? Math.pow(10, Math.floor(ut.log10(t.min)) + 1) : 10), null === t.minNotZero && (t.min > 0 ? t.minNotZero = t.min : t.max < 1 ? t.minNotZero = Math.pow(10, Math.floor(ut.log10(t.max))) : t.minNotZero = 1)
            },
            buildTicks: function() {
                var t = this,
                    e = t.options.ticks,
            ...
            getPixelForValue: function(t) {
                var e, i, n, a, o, r = this,
                    ...
                    h = 0;
                return t = +r.getRightValue(t), l ? (n = r.end, a = r.start, o = -1) : (n = r.start, a = r.end, o = 1), r.isHorizontal() ? (e = r.width, i = l ? r.right : r.left) : (e = r.height, o *= -1, i = l ? r.top : r.bottom), t !== n && (0 === n && (e -= h = bi(s.fontSize, st.global.defaultFontSize), n = u), 0 !== t && (h += e / (d(a) - d(n)) * (d(t) - d(n))), i += o * h), i
            },
            getValueForPixel: function(t) {
                var e, i, n, a, o = this,
                    r = o.options.ticks,
    ...
    function Ii(t) {
        var e = t.ticks;
        return e.display && t.display ? Mi(e.fontSize, st.global.defaultFontSize) + 2 * e.backdropPaddingY : 0
    }
    ...
    var Ri = gi.extend({
            ...
            setReductions: function(t, e, i) {
                ...
                a = Li(a), o = Li(o), r = Li(r), s = Li(s), n.drawingArea = Math.min(Math.floor(t - (a + o) / 2), Math.floor(t - (r + s) / 2)), n.setCenterPoint(a, o, r, s)
            },
                ...
                if (e.display) {
                    ...
                    (e.angleLines.display || e.pointLabels.display) && function(t) {
                        var e = t.ctx,
                            ...
                            a = i.gridLines,
                            o = i.pointLabels,
                            r = Mi(n.lineWidth, a.lineWidth),
                            s = Mi(n.color, a.color),
                            l = Ii(i);
                        ...
                        for (var h = Pi(t) - 1; h >= 0; h--) {
                            ...
                            if (o.display) {
                                var f = 0 === h ? l / 2 : 0,
                                    ...
                                    p = _i(o.fontColor, h, st.global.defaultFontColor);
                                e.fillStyle = p;
                                var m = t.getIndexAngle(h),
                                    v = ut.toDegrees(m);
                                e.textAlign = Di(v), Fi(v, t._pointLabelSizes[h], g), Ti(e, t.pointLabels[h] || "", g, u.lineHeight)
                            }
                        }
                        e.restore()
                        ...
                        if (s > 0 || n.reverse) {
                            ...
                            if (i.display && 0 !== s && function(t, e, i, n) {
                                ...
                                var d = Mi(n.fontColor, st.global.defaultFontColor);
        ...
        Oi = Si;
    Ri._defaults = Oi;
    var zi = ut.valueOrDefault,
        Bi = Number.MIN_SAFE_INTEGER || -9007199254740991,
        Ni = Number.MAX_SAFE_INTEGER || 9007199254740991,
        Wi = {
            millisecond: {
                common: !0,
                size: 1,
    ...
    function Yi(t, e) {
        ...
        var i = t.options.time,
            n = qi(t, t.getRightValue(e));
        return null === n ? n : (i.round && (n = +t._adapter.startOf(n, i.round)), n)
    }

    function Ui(t) {
        for (var e = Vi.indexOf(t) + 1, i = Vi.length; e < i; ++e)
            if (Wi[Vi[e]].common) return Vi[e]
    }
    var Xi = ui.extend({
        initialize: function() {
        ...
        determineDataLimits: function() {
            var t, e, i, n, a, o, r = this,
                ...
                p = [],
                m = s.data.labels || [];
            for (t = 0, i = m.length; t < i; ++t) p.push(Yi(r, m[t]));
            for (t = 0, i = (s.data.datasets || []).length; t < i; ++t)
                if (s.isDatasetVisible(t))
                    if (a = s.data.datasets[t].data, ut.isObject(a[0]))
                        for (g[t] = [], e = 0, n = a.length; e < n; ++e) o = Yi(r, a[e]), f.push(o), g[t][e] = o;
                    else {
                        for (e = 0, n = p.length; e < n; ++e) f.push(p[e]);
                        g[t] = p.slice(0)
                    }
            else g[t] = [];
            p.length && (p = Hi(p).sort(Ei), h = Math.min(h, p[0]), c = Math.max(c, p[p.length - 1])), f.length && (f = Hi(f).sort(Ei), h = Math.min(h, f[0]), c = Math.max(c, f[f.length - 1])), h = Yi(r, d.min) || h, c = Yi(r, d.max) || c, h = h === Ni ? +l.startOf(Date.now(), u) : h, c = c === Bi ? +l.endOf(Date.now(), u) + 1 : c, r.min = Math.min(h, c), r.max = Math.max(h + 1, c), r._horizontal = r.isHorizontal(), r._table = [], r._timestamps = {
                data: f,
                datasets: g,
                labels: p
            }
                    ...
                    l = function(t, e, i, n) {
                        var a, o = t._adapter,
                            ...
                            l = s.unit || function(t, e, i, n) {
                                var a, o, r, s = Vi.length;
                                for (a = Vi.indexOf(t); a < s - 1; ++a)
                                    if (r = (o = Wi[Vi[a]]).steps ? o.steps[o.steps.length - 1] : Ni, o.common && Math.ceil((i - e) / (r * o.size)) <= n) return Vi[a];
                                return Vi[s - 1]
                            }(s.minUnit, e, i, n),
                            d = Ui(l),
                        ...
                        return m.push(+a), m
                    }(n, a, o, n.getLabelCapacity(a))
            }
            for ("ticks" === r.bounds && l.length && (a = l[0], o = l[l.length - 1]), a = Yi(n, s.min) || a, o = Yi(n, s.max) || o, t = 0, e = l.length; t < e; ++t)(i = l[t]) >= a && i <= o && d.push(i);
            return n.min = a, n.max = o, n._unit = s.unit || function(t, e, i, n, a) {
                    var o, r;
                    for (o = Vi.length - 1; o >= Vi.indexOf(i); o--)
                        if (r = Vi[o], Wi[r].common && t._adapter.diff(a, n, r) >= e.length) return r;
                    return Vi[i ? Vi.indexOf(i) : 0]
                }(n, d, s.minUnit, n.min, n.max), n._majorUnit = Ui(n._unit), n._table = function(t, e, i, n) {
                    ...
                    var o, r, s = 0,
                        l = 0;
                    return a.offset && e.length && (a.time.min || (o = ji(t, "time", e[0], "pos"), s = 1 === e.length ? 1 - o : (ji(t, "time", e[1], "pos") - o) / 2), a.time.max || (r = ji(t, "time", e[e.length - 1], "pos"), l = 1 === e.length ? r : (r - ji(t, "time", e[e.length - 2], "pos")) / 2)), {
                        start: s,
                        end: l
                    }
        ...
        getLabelForIndex: function(t, e) {
            ...
            return ut.isObject(s) && (r = i.getRightValue(s)), o.tooltipFormat ? n.format(qi(i, r), o.tooltipFormat) : "string" == typeof r ? r : n.format(qi(i, r), o.displayFormats.datetime)
        },
        tickFormatFunction: function(t, e, i, n) {
            var a = this._adapter,
                ...
                g = c ? h : o.ticks.minor,
                p = zi(g.callback, g.userCallback);
            return p ? p(f, e, i) : f
        },
        ...
        getLabelWidth: function(t) {
            var e = this.options.ticks,
                ...
                a = Math.cos(n),
                o = Math.sin(n);
            return i * a + zi(e.fontSize, st.global.defaultFontSize) * o
        },
    ...
    ai._date.override("function" == typeof t ? {
        _id: "moment",
        formats: function() {
            return Gi
        },
    ...
    function tn(t) {
        var e = t.fill,
            i = "dataset";
        return !1 === e ? null : (isFinite(e) || (i = "boundary"), Zi[i](t))
    }
    ...
    var an = {
            ...
            afterDatasetsUpdate: function(t, e) {
                var i, n, a, o, r = (t.data.datasets || []).length,
                    s = e.propagate,
                    l = [];
                for (n = 0; n < r; ++n) o = null, (a = (i = t.getDatasetMeta(n)).dataset) && a._model && a instanceof Nt.Line && (o = {
                    visible: t.isDatasetVisible(n),
                    fill: $i(a, n, r),
                    chart: t,
                    el: a
                }), i.$filler = o, l.push(o);
                for (n = 0; n < r; ++n)(o = l[n]) && (o.fill = Qi(l, n, s), o.boundary = Ji(o), o.mapper = tn(o))
            },
                ...
                if (i) {
                    ...
                    s && l && r.length && (ut.canvas.clipArea(n, t.chartArea), function(t, e, i, n, a, o) {
                        var r, s, l, d, u, h, c, f = e.length,
                            ...
                            v = 0,
                            b = 0;
                        for (t.beginPath(), r = 0, s = f + !!o; r < s; ++r) u = i(d = e[l = r % f]._view, l, n), h = en(d), c = en(u), h && c ? (v = p.push(d), b = m.push(u)) : v && b && (g ? (h && p.push(d), c && m.push(u)) : (nn(t, p, m, v, b), v = b = 0, p = [], m = []));
    ...
    var ln = pt.extend({
            ...
            if (d ? (l.width = t.maxWidth, l.height = n ? 10 : 0) : (l.width = n ? 10 : 0, l.height = t.maxHeight), n)
                if (a.font = o.string, d) {
                    ...
                    a.textAlign = "left", a.textBaseline = "top", ut.each(t.legendItems, function(t, e) {
                        var n = sn(i, r) + r / 2 + a.measureText(t.text).width;
        ...
        draw: function() {
            ...
            if (e.display) {
                var l, d = t.ctx,
                    u = rn(i.fontColor, n.defaultFontColor),
                ...
                ut.each(t.legendItems, function(n, u) {
                    ...
                    p ? u > 0 && b + v + i.padding > t.left + t.minSize.width && (x = l.y += m, l.line++, b = l.x = t.left + (r - s[l.line]) / 2 + i.padding) : u > 0 && x + m > t.top + t.minSize.height && (b = l.x = b + t.columnWidths[l.line] + i.padding, x = l.y = t.top + i.padding, l.line++),
                        function(t, i, n) {
                            if (!(isNaN(f) || f <= 0)) {
                                d.save();
                                var r = rn(n.lineWidth, o.borderWidth);
                                if (d.fillStyle = rn(n.fillStyle, a), d.lineCap = rn(n.lineCap, o.borderCapStyle), d.lineDashOffset = rn(n.lineDashOffset, o.borderDashOffset), d.lineJoin = rn(n.lineJoin, o.borderJoinStyle), d.lineWidth = r, d.strokeStyle = rn(n.strokeStyle, a), d.setLineDash && d.setLineDash(rn(n.lineDash, o.borderDash)), e.labels && e.labels.usePointStyle) {
                        ...
                        }(0, 0, n, h), p ? l.x += v + i.padding : l.y += m
                })
            }
        },
    ...
    var un = {
            ...
            beforeUpdate: function(t) {
                var e = t.options.legend,
                    i = t.legend;
                e ? (ut.mergeIf(e, st.global.legend), i ? (ke.configure(t, i, e), i.options = e) : dn(t, e)) : i && (ke.removeBox(t, i), delete t.legend)
            },
    ...
    var gn = {},
        ...
        vn = {
            ...
            beforeUpdate: function(t) {
                var e = t.options.title,
                    i = t.titleBlock;
                e ? (ut.mergeIf(e, st.global.title), i ? (ke.configure(t, i, e), i.options = e) : fn(t, e)) : i && (ke.removeBox(t, i), delete t.titleBlock)
            }
        };
    for (var bn in gn.filler = pn, gn.legend = mn, gn.title = vn, ei.helpers = ut,
            function() {
                function t(t, e, i) {
                    var n;
            ...
            }(), ei._adapters = ai, ei.Animation = vt, ei.animationService = bt, ei.controllers = de, ei.DatasetController = Mt, ei.defaults = st, ei.Element = pt, ei.elements = Nt, ei.Interaction = me, ei.layouts = ke, ei.platform = Be, ei.plugins = Ne, ei.Scale = ui, ei.scaleService = We, ei.Ticks = oi, ei.Tooltip = Ge, ei.helpers.each(Ki, function(t, e) {
                ei.scaleService.registerScaleType(e, t, t._defaults)
            }), gn) gn.hasOwnProperty(bn) && ei.plugins.register(gn[bn]);
    ei.platform.initialize();
    var xn = ei;
    return "undefined" != typeof window && (window.Chart = ei), ei.Chart = ei, ei.Legend = gn.legend._element, ei.Title = gn.title._element, ei.pluginService = ei.plugins, ei.PluginBase = ei.Element.extend({}), ei.canvasHelpers = ei.helpers.canvas, ei.layoutService = ei.layouts, ei.LinearScaleBase = gi, ei.helpers.each(["Bar", "Bubble", "Doughnut", "Line", "PolarArea", "Radar", "Scatter"], function(t) {
        ei[t] = function(e, i) {
            return new ei(e, ei.helpers.merge(i || {}, {
