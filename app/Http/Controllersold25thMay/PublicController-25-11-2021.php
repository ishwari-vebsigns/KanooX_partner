...
class PublicController extends Controller
{
    ...
    public function postContactUs(Request $request){
        ...
        // $data = array('name'=>$contact_name,'email'=>$contact_email,'phone'=>$contact_number,'message'=>$contact_message,);

        // Mail::send('mail/contactMail', $data, function($message) use ($contact_email,$contact_name){
        // $message->to('vebsigns@gmail.com', 'Business To Business')->subject('New user Contacted');
        // $message->from($contact_email,$contact_name);
        // });

        // Mail::send('mail/userContactMail', $data, function($message) use ($contact_email,$contact_name){
        // $message->to($contact_email,$contact_name)->subject('Thank you  for contacting us.');
        // $message->from('vebsigns@gmail.com', 'Business To Business');
        // });


         $notification = array(
              'message' => 'Thanks! Your Information Sent Successfully', 
              'alert-type' => 'success'
              );
...
//==============================================Cart Data Start==================
 ...
 public function getRepeatOrder(Request $request){
     ...
     foreach($order_items as $order_item){
         ...
         $user_cart=Cart::where('user_id',$user_id)->where('product_id',$product_id)->first();
         if($user_cart==""){
           $cart = new Cart;
