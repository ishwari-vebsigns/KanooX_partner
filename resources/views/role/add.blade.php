...
<div class="content-body">
            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{$base_url}}/admin/role/all">Role</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-10">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-number">Add Role<span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6 {{ $errors->has('role') ? ' has-error' : '' }}">
                                                        <input type="text" class="form-control" value="{{old('role')}}" id="role" name="role" placeholder="Enter role name" required>
                                                        @if ($errors->has('role'))
