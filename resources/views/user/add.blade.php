            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{$base_url}}/admin/user/all">Users</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="form-control" id="val-skill" name="role_id" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 {{ $errors->has('user_name') ? ' has-error' : '' }}">
                                                        <input type="text" class="form-control" value="{{old('user_name')}}" id="val-username" name="user_name" placeholder="Enter User Name">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 {{ $errors->has('phone') ? ' has-error' : '' }}">
                                                        <input type="text" class="form-control" value="{{old('phone')}}" id="val-phoneus" name="phone" placeholder="Enter Contact No.">
                                                        @if ($errors->has('phone'))
                                                        <span class="help-block">
