...
<script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
    ...
    <div class="nav-header">
        <a href="https://partner.loansarovar.com/" class="brand-logo">
                     ...
                     <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" id="notidropdown">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="media dropdown-item">
                                        ...
                                        <div class="media-body">
                                            <a class="{{$mnotification->notification_id}}" onclick="getnotid({{Auth::user()->id}},{{$mnotification->notification_id}})">
                                                <p><strong>Admin</strong> has added a <strong>{{$mnotification->title}}</strong> Successfully
                                                </p>
                                            </a>
                                    ...
                                    <li class="media dropdown-item">
                                        ...
                                        <div class="media-body">
                                            <a data-toggle="modal" class="{{$mnotification->notification_id}}" onclick="getnotid({{Auth::user()->id}}, {{$mnotification->notification_id}})">
                                                <p><strong>Admin</strong> has added a <strong>{{$mnotification->title}}</strong> Successfully
                                                </p>
                                            </a>
                                ...
                                <a class="all-notification" href="{{$base_url}}/admin/all-notifications">See all notifications <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </li>
    ...
    <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
    <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=64621a4aa4982d0019d1757d&product=inline-share-buttons&source=platform" async="async"></script>
    ...
    document.querySelector(".sweet-image-message").onclick = function () {
      axios.get('{{$base_url}}/fetch-qr/{{$agentqrcode->agent_access_code}}')
        .then(response => {
          const html = response.data;
          const shareButtonsHtml = '<a href="{{$base_url}}/fetch-qr/{{$agentqrcode->agent_access_code}}" target="_blank" class="">View and Share</a>';
          Swal.fire({
            html: `${html} ${shareButtonsHtml}`,
            ...
            if (result.value == true) {
              const url = '{{$base_url}}/fetch-qr/{{$agentqrcode->agent_access_code}}';
