    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
      <div class="fixed top-0 hidden p-6 lg:block lg:px-12">
        <a href="{{$base_url}}/" class="flex items-center space-x-2">
          <img class="h-12 w-30" id="imgnew" src="{{$base_url}}/login-images/logo.png" alt="logo">
      ...
      <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700">
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
          <div class="text-center">
            <img class="mx-auto h-16 w-30" id="imgnew" src="{{$base_url}}/login-images/logo.png" alt="logo">
            <div class="mt-4">
      ...
      <div class="mt-4 text-center text-xs+">
        <p class="line-clamp-1">
          <span>Dont have OTP?</span>

          <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="{{$base_url}}\resent-otp\{{$user->id}}">Resent OTP</a>
        </p>
      </div>
        </div>
      </main>
