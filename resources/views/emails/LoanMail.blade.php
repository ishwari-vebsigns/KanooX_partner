<html lang="en">
<head>
<title>Responsive Email Design</title>
<meta charset="utf-8">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="left" class="logo">
                  <img src="https://bharatnidhi.com/assets/img/logo.jpeg" alt="Frontend Masters" width="100" border="0" style="display: block; margin-left:40%" />
                </td>
        ...
        <tr>
          <td>
            <table border="0" cellpadding="0" cellspacing="0"  width="100%">
              <tr>
                <td class="mobile-image-pad">
                  <img src="https://www.shutterstock.com/shutterstock/videos/1091661443/thumb/10.jpg" alt="Look at that full class" width="600" height="236" border="0" style="display: block; padding: 0; color: #ffffff; font-family: Arial, sans-serif; font-weight: bold; font-size: 24px; -webkit-border-radius: 4px; border-radius: 4px;" class="fluid-image" />
                </td>
              </tr>
              {{-- <tr>
                <td align="center" style="padding: 20px 0 10px 0; color: #ffffff; font-family: Arial, sans-serif; font-weight: bold; font-size: 32px; line-height: 36px;" class="mobile-title-pad">
                  @if($mailData['type']=="congrats")
                  Congratulations!!!
                  @endif
                  @if($mailData['type']=="reject")
                  Rejected!!!
                  @endif
                </td>
              </tr> --}}
              <tr><td align="center" style="padding: 10px 0 10px 0; font-size: 18px;">Dear {{ $mailData['agent_name'] }},</td></tr>
              <tr>
                <td align="center" style="color: #aaaaaa; font-family: Arial, sans-serif; font-weight: normal; font-size: 18px; line-height: 22px;" class="mobile-text-pad">
                    <br>
                    {{ $mailData['content'] }}
                    <ol>
                    <li>{{ $mailData['list1'] }}</li>
                    <li>{{ $mailData['list2'] }}</li>
                    <li>{{ $mailData['list3'] }}</li>
                    ...
                    <tr>
                      <td align="center" style="padding: 20px 0 0 0;">
                        {{-- <table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td bgcolor="#f46e6c" style="padding: 12px 18px 12px 18px; -webkit-border-radius:3px; border-radius:3px" align="center" class="mobile-button"><a href="https://bharatnidhi.com/panel/login" style="font-size: 16px; font-family: Arial, sans-serif; font-weight: normal; color: #ffffff; text-decoration: none;">Login Now &rarr;</a></td>
                          </tr>
                        </table> --}}
                      </td>
                    </tr>
