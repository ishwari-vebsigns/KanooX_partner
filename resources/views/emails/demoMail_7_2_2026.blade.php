            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td align="left" class="logo">
                  <img src="https://partner.loansarovar.com/login-images/logo.png" alt="Frontend Masters" width="100" border="0" style="display: block; margin-left:40%" />
                </td>
        ...
        <tr>
          <td>
            <table border="0" cellpadding="0" cellspacing="0"  width="100%">
              ...
              <tr><td align="center" style="padding: 10px 0 10px 0; font-size: 18px;">Dear {{ $mailData['body'] }},</td></tr>
              <tr>
