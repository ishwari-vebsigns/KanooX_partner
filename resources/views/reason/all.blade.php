            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="{{$base_url}}/admin/walletreason/all">Wallet Settings</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                 ...
                 <P></P>              <h4 class="card-title">
                    @if($my_permissions->contains('REASON_ADD'))
                    <a href="add" style="color:white;" class="btn btn-secondary">Add Reason</a>
                    @endif
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    @if($my_permissions->contains('PINCODE_DETAILS'))
                        return '<a type="button" href="' + data.reason_id + '" class="btn btn-dark">Details</a>'
                    @endif
