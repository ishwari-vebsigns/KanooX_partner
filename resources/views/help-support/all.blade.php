            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">All Support</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                 ...
                 <P></P>              <h4 class="card-title">
                    @if($my_permissions->contains('SUPPORT_ADD'))
                    <a href="{{$base_url}}/admin/support" style="color:white;" class="btn btn-secondary">Add Support</a>
                    @endif
 ...
 <script>
    ...
    var table = $('#example').DataTable({
        ...
        columns: [
            ...
            //         @if($my_permissions->contains('SUPPORT_DETAILS'))
            //             return '<a type="button" href="' + data.support_id + '" class="btn btn-dark">Details</a>'
            //         @endif
