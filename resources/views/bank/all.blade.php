                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{$base_url}}/admin/bank/all">Banks</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
        ...
        columns: [
            { data: "bank_id" },
            {
                ...
                render: function(data, type, row) {
                    if(data!=null){
                        return '<div class="product-div" style="height:50px;width:50px"><center><img class="img-fluid" id="product_img" src="{{$base_url}}/storage/app/'+data+'" style="max-height:50px;max-width:45px;"></center></div>';
                    }
                    else{
                        return '<div class="product-div" style="height:50px;width:50px"><center><img class="img-fluid" id="product_img" src={{$base_url}}/web-assets/images/resources/product.png style="max-height:50px;max-width:45px;"></center></div>';
