...
.banks-page .kx-title-wrap {
    display: flex;
    align-items: flex-start;
    gap: 14px;
}

.banks-page .kx-title-icon {
    flex: 0 0 auto;
    width: 46px;
    height: 46px;
    border-radius: 12px;
...
.banks-page .kx-page-subtitle {
    margin: 3px 0 0;
    font-size: 13.5px;
    color: var(--kx-muted);
}

.banks-page .kx-breadcrumb {
    margin: 0;
    padding: 8px 14px;
    background: #fff;
...
.banks-page .kx-breadcrumb a {
    color: var(--kx-muted);
    text-decoration: none;
}

.banks-page .kx-breadcrumb .kx-crumb-current {
    color: var(--kx-primary-dark);
    font-weight: 600;
}
.banks-page .dataTables_wrapper .dataTables_length,
.banks-page .dataTables_wrapper .dataTables_filter {
    display: inline-flex;
    align-items: center;
...
.banks-page .kx-card-header-left {
    display: flex;
    align-items: center;
    gap: 14px;
}

.banks-page .kx-card-icon {
    flex: 0 0 auto;
    width: 40px;
    height: 40px;
    border-radius: 10px;
...
.banks-page .kx-card-subtitle {
    margin: 2px 0 0;
    font-size: 12.5px;
    color: var(--kx-muted);
}

.banks-page .kx-card-actions {
    display: flex;
    align-items: center;
    gap: 10px;
    flex-wrap: wrap;
...
/* ---------- Table ---------- */
.banks-page .kx-table-wrap {
    padding: 10px 26px 26px;
    overflow: visible;
}

.banks-page table.dataTable {
    width: 100% !important;
    border-collapse: separate !important;
    border-spacing: 0;
}

.banks-page table.dataTable thead th {
    background: var(--kx-page-bg);
    color: var(--kx-primary-dark);
    font-size: 11.5px;
    font-weight: 700;
...
.banks-page table.dataTable thead th:first-child { border-radius: 10px 0 0 10px; }
.banks-page table.dataTable thead th:last-child { border-radius: 0 10px 10px 0; }

.banks-page table.dataTable tbody td {
    padding: 14px 16px !important;
    font-size: 13.5px;
    color: var(--kx-text);
...
.banks-page table.dataTable tbody tr {
    transition: background 0.15s ease;
}

.banks-page table.dataTable tbody tr:hover td {
    background: #FCF6FC;
}

.banks-page table.dataTable tbody tr:last-child td {
    border-bottom: none !important;
}

/* Bank ID pill */
.banks-page .kx-id-pill {
...
/* Bank name */
.banks-page .kx-bank-name {
    font-weight: 600;
    color: var(--kx-primary-dark);
}

/* Updated at */
.banks-page .kx-updated {
    display: flex;
    align-items: center;
    gap: 8px;
    color: var(--kx-muted);
...
.banks-page .kx-updated i {
    color: var(--kx-primary);
    font-size: 13px;
}

/* Status pills */
.banks-page .kx-status {
    display: inline-flex;
    align-items: center;
    gap: 6px;
    padding: 5px 12px;
...
.banks-page .kx-status-active {
    background: #EAF8EF;
    color: #238B45;
}
.banks-page .kx-status-active .kx-dot { background: #238B45; }

.banks-page .kx-status-inactive {
    background: #FDECEC;
    color: #D64545;
}
.banks-page .kx-status-inactive .kx-dot { background: #D64545; }

/* Actions dropdown */
.banks-page .kx-actions-dropdown {
    position: relative;
    display: inline-block;
}

.banks-page .kx-btn-actions {
    display: inline-flex;
    align-items: center;
    gap: 8px;
    padding: 8px 16px;
...
.banks-page .kx-btn-actions:hover {
    background: var(--kx-primary-dark);
    border-color: var(--kx-primary-dark);
    color: #fff;
}

.banks-page .kx-actions-dropdown .dropdown-menu {
    border-radius: 10px;
    border: 1px solid var(--kx-border);
    box-shadow: 0 10px 30px rgba(57, 35, 103, 0.16);
    padding: 6px;
    min-width: 150px;
}

.banks-page .kx-actions-dropdown .dropdown-item {
    border-radius: 7px;
    font-size: 13px;
    padding: 8px 12px;
    color: var(--kx-text);
...
.banks-page .kx-actions-dropdown .dropdown-item:hover {
    background: var(--kx-soft);
    color: var(--kx-primary-dark);
}

.banks-page .kx-actions-dropdown .dropdown-item.kx-item-danger {
    color: #D64545;
}

.banks-page .kx-actions-dropdown .dropdown-item.kx-item-danger:hover {
    background: #FDECEC;
    color: #D64545;
}

/* ---------- DataTables controls ---------- */
.banks-page .dataTables_wrapper .dataTables_length select,
.banks-page .dataTables_wrapper .dataTables_filter input {
    background: #fff;
    border: 1px solid var(--kx-border);
    border-radius: 8px;
    height: 40px;
...
.banks-page .dataTables_wrapper .dataTables_filter input:focus,
.banks-page .dataTables_wrapper .dataTables_length select:focus {
    border-color: var(--kx-primary);
    box-shadow: 0 0 0 3px rgba(157, 56, 149, 0.12);
}

.banks-page .dataTables_wrapper .dataTables_filter label,
.banks-page .dataTables_wrapper .dataTables_length label {
    font-size: 13px;
    color: var(--kx-muted);
    font-weight: 500;
    display: flex;
...
.banks-page .dataTables_wrapper .dataTables_info {
    color: var(--kx-muted);
    font-size: 12.5px;
    padding-top: 14px;
}
...
/* Pagination */
.banks-page .dataTables_wrapper .dataTables_paginate {
    margin-top: 15px;
}

.banks-page .dataTables_wrapper .dataTables_paginate .paginate_button {
    display: inline-block;
    padding: 6px 14px;
    margin: 0 3px;
    border-radius: 8px;
...
.banks-page .dataTables_wrapper .dataTables_paginate .paginate_button:hover {
...
.banks-page .dataTables_wrapper .dataTables_paginate .paginate_button.current {
    background: linear-gradient(135deg, var(--kx-primary), var(--kx-primary-dark)) !important;
    border-color: var(--kx-primary-dark);
    color: #fff !important;
}

.banks-page .dataTables_wrapper .dataTables_paginate .paginate_button.disabled {
    color: #bbb !important;
    cursor: not-allowed;
    background: #fafafa;
}

.banks-page .dataTables_wrapper .dataTables_paginate .paginate_button.disabled:hover {
...
<div class="content-body banks-page">
    <div class="container-fluid">
        ...
        <div class="kx-page-head">
            <div class="kx-title-wrap">
                ...
                <div>
                    ...
                    <p class="kx-page-subtitle">
                        Manage and monitor all partner banks from one place.
            ...
            <nav class="kx-breadcrumb">
                <a href="{{$base_url}}/admin">Home</a> / <span class="kx-crumb-current">Banks</span>
            </nav>
        </div>
                ...
                <div class="kx-card">
                    <div class="kx-card-header">
                        <div class="kx-card-header-left">
                            ...
                            <div>
                                <h4 class="kx-card-title">Banks</h4>
                                <p class="kx-card-subtitle">Manage and monitor your partner banks</p>
                            </div>
                        </div>
                        <div class="kx-card-actions">
                            @if($my_permissions->contains('BANK_ADD'))
                            <a href="add" class="kx-btn kx-btn-primary"><i class="fa fa-plus"></i> Add Bank</a>
                            @endif
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    if(data!=null){
                        return '<div class="kx-bank-image"><img src="{{$base_url}}/storage/app/'+data+'"></div>';
                    }
                    else{
                        return '<div class="kx-bank-image"><img src="{{$base_url}}/web-assets/images/resources/product.png"></div>';
                    }
                }
            },
            {
                ...
                render: function(data) {
                    return '<span class="kx-bank-name">' + data + '</span>';
                }
            },
            {
                "mData": "updated_at",
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return '<div class="btn-group kx-actions-dropdown" role="group"><button type="button" class="kx-btn-actions dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Actions</button><div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 35px, 0px);"><a class="dropdown-item" href="' + data.bank_id + '">Details</a><a class="dropdown-item kx-item-danger" href="' + data.bank_id + '/delete/all" >Delete</a></div></div>'
                    @endif
                }
            },
