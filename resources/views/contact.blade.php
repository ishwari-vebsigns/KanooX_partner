...
@section('content') 
        ...
        <section class="breadcrumb-area">
            <div class="breadcrumb-area-bg" style="background-image: url(web-assets/images/backgrounds/breadcrumb-area-bg-6.jpg);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="contact-form">
                            <form id="contact-form" name="contact_form" class="default-form2" action="contact" method="POST">
                                @csrf
                                <div class="form-group">
                                    <label>Name</label>
                                    <div class="input-box">
                                        <input type="text" name="name" id="formName" placeholder="xxxxxx" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Email Address</label>
                                    <div class="input-box">
                                        <input type="email" name="email" data-gtm-form-interact-field-id="0" id="formEmail" placeholder="" required="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-box">
                                        <input type="text" pattern="/^-?\d+\.?\d*$/" onkeypress="if(this.value.length==10) return false;" name="phone_number" value="" id="formPhone" placeholder="">
                                    </div>
                                </div>
                        ...
                        <div class="tab-content-box-item tab-content-box-item-active" id="branch">
                            <div class="branch-atm-tab-content-box-item">
                                <div class="inner-title">
                                    <h3>Finbank,<br> San Fransisco</h3>
                                </div>
                                <ul>
                                    <li>
                                        <h3>ifsc</h3>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="contact-info">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a class="color2" href="mailto:yourmail@email.com">customercare@finbank.com</a>
                                                                    </li>
                                                                </ul>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="contact-info">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a class="color2" href="mailto:yourmail@email.com">creditcard@finbank.com</a>
                                                                    </li>
                                                                </ul>
                                                            </td>
                                                        </tr>
