    ...
    <div class="container-fluid">
        ...
        <div class="kx-page-head">
            ...
            <nav class="kx-breadcrumb">
                <a href="{{$base_url}}/admin/service/all">Services</a> / <span class="kx-crumb-current">Service Details</span>
            </nav>
        </div>
                        ...
                        <form class="{{$service->service_id}}" action="{{$service->service_id}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="kx-field">
                                ...
                                <div class="kx-field-control {{ $errors->has('service_name') ? ' has-error' : '' }}">
                                    <input type="text" value="{{old('service_name',$service->service_name)}}" class="kx-input" id="service_name" name="service_name" placeholder="Service Name">
                            ...
                            <div class="kx-field">
                                ...
                                <div class="kx-field-control {{ $errors->has('service_url') ? ' has-error' : '' }}">
                                    <input type="text" value="{{old('service_url',$service->service_url)}}" class="kx-input" id="service_url" name="service_url" placeholder="Service URL" required>
                            ...
                            <div class="kx-field">
                                ...
                                <div class="kx-field-control">
                                    ...
                                    <span class="kx-image-preview">
                                        <img src="{{ asset('storage/app/' . $service->service_image) }}">
                                    </span>
                                    @endif
