    ...
    <div class="container-fluid">
        ...
        <div class="kx-page-head">
            <div class="kx-title-wrap">
                ...
                <div>
                    ...
                    <p class="kx-page-subtitle">
                        Manage and monitor all available sub-services from one place.
            ...
            <nav class="kx-breadcrumb">
                <a href="{{$base_url}}/admin">Home</a> / <span class="kx-crumb-current">Sub-Services</span>
            </nav>
        </div>
                ...
                <div class="kx-card">
                    <div class="kx-card-header">
                        <div class="kx-card-header-left">
                            ...
                            <div>
                                <h4 class="kx-card-title">Sub-Services</h4>
                                <p class="kx-card-subtitle">Manage and monitor your available sub-services</p>
                            </div>
                        </div>
                        <div class="kx-card-actions">
                            @if($my_permissions->contains('SUBSERVICE_ADD'))
                            <a href="add" class="kx-btn kx-btn-primary"><i class="fa fa-plus"></i> Add Sub Service</a>
                            @endif
