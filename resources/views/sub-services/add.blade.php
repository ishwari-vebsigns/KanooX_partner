...
/* ---------- Page header ---------- */
.subservice-add-page .kx-page-head {
    display: flex;
...
.subservice-add-page .kx-title-wrap {
    display: flex;
    align-items: flex-start;
    gap: 14px;
}

.subservice-add-page .kx-title-icon {
    flex: 0 0 auto;
    width: 46px;
    height: 46px;
    border-radius: 12px;
...
.subservice-add-page .kx-page-title {
    margin: 0;
    font-size: 22px;
    font-weight: 700;
    color: var(--kx-text);
...
.subservice-add-page .kx-page-subtitle {
    margin: 3px 0 0;
    font-size: 13.5px;
    color: var(--kx-muted);
}

.subservice-add-page .kx-breadcrumb {
    margin: 0;
    padding: 8px 14px;
    background: #fff;
...
.subservice-add-page .kx-breadcrumb a {
    color: var(--kx-muted);
    text-decoration: none;
}

.subservice-add-page .kx-breadcrumb a:hover {
    color: var(--kx-primary);
}

.subservice-add-page .kx-breadcrumb .kx-crumb-current {
    color: var(--kx-primary-dark);
    font-weight: 600;
}

/* ---------- KYC alert ---------- */
.subservice-add-page .kx-kyc-alert {
    display: flex;
    align-items: center;
    gap: 12px;
    padding: 14px 18px;
...
.subservice-add-page .kx-kyc-alert i {
    font-size: 16px;
    flex: 0 0 auto;
}

.subservice-add-page .kx-kyc-alert a {
    color: #392367;
    font-weight: 700;
...
.subservice-add-page .kx-card-header {
    display: flex;
    align-items: center;
    gap: 14px;
    padding: 22px 26px;
...
.subservice-add-page .kx-card-icon {
    flex: 0 0 auto;
    width: 40px;
    height: 40px;
    border-radius: 10px;
...
.subservice-add-page .kx-card-title {
    margin: 0;
    font-size: 16.5px;
    font-weight: 700;
    color: var(--kx-text);
...
.subservice-add-page .kx-card-subtitle {
    margin: 2px 0 0;
    font-size: 12.5px;
    color: var(--kx-muted);
}
...
/* ---------- Form body ---------- */
.subservice-add-page .kx-form-body {
    padding: 30px 26px 32px;
}

.subservice-add-page .kx-field {
    display: flex;
    flex-wrap: wrap;
    align-items: flex-start;
    gap: 4px 24px;
...
.subservice-add-page .kx-field:last-of-type {
    margin-bottom: 0;
}

.subservice-add-page .kx-field-label {
    flex: 0 0 200px;
    max-width: 200px;
    padding-top: 10px;
    font-size: 13.5px;
...
.subservice-add-page .kx-field-label .text-danger {
    color: #D64545;
}

.subservice-add-page .kx-field-control {
    flex: 1 1 320px;
    max-width: 420px;
}

.subservice-add-page .kx-input,
.subservice-add-page select.kx-input,
.subservice-add-page textarea.kx-input {
    width: 100%;
    border: 1px solid var(--kx-border);
    border-radius: 9px;
    padding: 0 14px;
...
.subservice-add-page .kx-input:focus,
.subservice-add-page select.kx-input:focus,
.subservice-add-page textarea.kx-input:focus {
    border-color: var(--kx-primary);
    box-shadow: 0 0 0 3px rgba(157, 56, 149, 0.12);
}

.subservice-add-page .kx-help-block {
    display: block;
    margin-top: 6px;
    font-size: 12px;
    color: #D64545;
...
/* file input */
.subservice-add-page .kx-file-input {
    width: 100%;
...
.subservice-add-page .kx-file-input:hover {
    border-color: var(--kx-primary);
    background: #fff;
}

/* ---------- Buttons ---------- */
.subservice-add-page .kx-actions {
    display: flex;
    gap: 10px;
    flex-wrap: wrap;
    padding-top: 6px;
...
<div class="content-body subservice-add-page">
    <div class="container-fluid">
        ...
        <div class="kx-page-head">
            ...
            <nav class="kx-breadcrumb">
                <a href="{{$base_url}}/admin/sub-services/all">Sub-Services</a> / <span class="kx-crumb-current">Add Sub Service</span>
            </nav>
        </div>
            ...
            <div class="col-lg-12">
                <div class="kx-card">
                    <div class="kx-card-header">
                        ...
                        <div>
                            <h4 class="kx-card-title">Add Sub Service</h4>
                            <p class="kx-card-subtitle">Enter the details for the new sub-service</p>
                        </div>
                    </div>
                        ...
                        <form class="" action="add" method="post" enctype='multipart/form-data'>
                            ...
                            <div class="kx-field">
                                ...
                                <div class="kx-field-control {{ $errors->has('sub_service_image') ? ' has-error' : '' }}">
                                    <input type="file" class="kx-file-input" value="{{old('sub_service_image')}}" id="sub_service_image" name="sub_service_image" required>
                            ...
                            <div class="kx-field">
                                ...
                                <div class="kx-field-control">
                                    <select class="kx-input" id="val-skill" name="service_id" value="{{old('service_id')}}" required>
                            ...
                            <div class="kx-field">
                                <label class="kx-field-label" for="sub_service">Sub Service Name <span class="text-danger">*</span></label>
                                <div class="kx-field-control {{ $errors->has('sub_service') ? ' has-error' : '' }}">
                                    <input type="text" class="kx-input" id="sub_service" name="sub_service" value="{{old('sub_service')}}" placeholder="Service Name">
                            ...
                            <div class="kx-field">
                                ...
                                <div class="kx-field-control {{ $errors->has('sub_service_url') ? ' has-error' : '' }}">
                                    <input type="text" class="kx-input" id="sub_service_url" name="sub_service_url" value="{{old('sub_service_url')}}" placeholder="Service URL" required>
                            ...
                            <div class="kx-field">
                                ...
                                <div class="kx-field-control">
                                    <textarea class="kx-input" id="val-suggestions" name="description" rows="5" placeholder="What would you like to see?" required>{{old('description')}}</textarea>
                                </div>
                            </div>
