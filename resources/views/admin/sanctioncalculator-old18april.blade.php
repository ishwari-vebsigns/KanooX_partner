  ...
  $(document).ready(function() {
    ...
    var x_one = 1; 
      ...
      if(x_one < max_fields_one){ 
        ...
        $("#input_fields_wrap_one").append('<div class="col-md-12" style="display: inline-flex;padding: 0px;"><div class="form-group" style="margin-right:15px;"><label for="proposalTitle3">Project Name</label><textarea type="text" class="form-control required project_name" value="0" rows="1" id="proposalTitle3" name="project_name[]"></textarea></div><div class="form-group"><label for="proposalTitle3">Project Cost</label><input type="text" class="form-control required project_cost'+x_one+'" value="0" id="proposalTitle3" name="project_cost[]"></div><a class="btn btn btn-outline-primary btn-sm dlt btn-align" style="height:29px;margin-top:4.1%;""><i class="fa fa-minus"></i></a></div>');
      }
