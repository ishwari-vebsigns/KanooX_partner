               ...
               <div class="row">
                      <div class="col-lg-2 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label" for="">Profit Margin</label>
                                <input class="form-control master_income_margin" required="" data-validation-required-message="This field is required" type="text" name="" value="40" placeholder="Income Margin">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control master_rental_margin" required="" data-validation-required-message="This field is required" type="text" name="" value="60" placeholder="Rental Margin">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control master_ltv_margin_one" required="" data-validation-required-message="This field is required" type="text" name="" value="90" placeholder="LTV Margin">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control master_ltv_margin_two" required="" data-validation-required-message="This field is required" type="text" name="" value="80" placeholder="LTV Margin">
                                @if ($errors->has('master_ltv_margin'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('master_ltv_margin') }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control master_ltv_margin_three" required="" data-validation-required-message="This field is required" type="text" name="" value="75" placeholder="LTV Margin">
                                @if ($errors->has('master_ltv_margin'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('master_ltv_margin') }}</strong>
                                </span>
                 ...
                 <span> <b>Latest Month</b> <input type="checkbox" class="month_six_check" name="year_two" checked=""></span>
                    ...
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <textarea class="form-control" required="" value="" rows="1" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Name"></textarea>
                        @if ($errors->has('name'))
                        <span class="help-block">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 {{ $errors->has('age') ? ' has-error' : '' }}" style="padding-left: 20px !important;">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <input class="form-control age" required="" value="37" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Age">
                          @if ($errors->has('age'))
                          <span class="help-block">
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_gross_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_depreciation_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_salary_remuneration_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_interest_on_loan" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_agriculture_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_other_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_total_gross_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_tax_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_other_ded_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_total_deduction_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_gross_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_depreciation_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_agriculture_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_other_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_gross_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_tax_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_other_ded_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_deduction_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_gross_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_depreciation_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_agriculture_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_other_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_gross_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_tax_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_other_ded_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_deduction_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_agriculture" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_salary_remuneration_year_one" readonly required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_depreciation" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Tax" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_ded" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_deduction_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_agriculture" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_depreciation" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Tax" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_ded" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_deduction_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_gross_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_agriculture_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_depreciation_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_gross_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_tax_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_ded_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_gross_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_agriculture_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_depreciation_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_gross_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_tax_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_ded_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_gross_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_agriculture_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_depreciation_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_gross_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_tax_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_ded_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_agriculture" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_depreciation" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Tax" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_ded" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_agriculture" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Agriculture Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_depreciation" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Profit" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Tax" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_ded" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control one_salary_gross_income" id="demo" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control one_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control one_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control one_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control two_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control two_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control two_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control two_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control three_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control three_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control three_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control three_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control four_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control four_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control four_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control four_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control five_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control five_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control five_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control five_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control six_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control six_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control six_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control six_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control average_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control average_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control average_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control average_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_one_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_one_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_one_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_one_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_two_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_two_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_two_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_two_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_three_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_three_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_three_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_three_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_four_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_four_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_four_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_four_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_five_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_five_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_five_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_five_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_six_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_six_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_six_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_six_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_average_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Profit" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_average_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Other Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_average_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_average_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
  ...
  <div class="row" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required future_rent" id="future_rent" value="0" name="future_rent">
     </div>
   ...
   <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required eligilble_rental_income" value="0" id="eligilble_rental_income" name="eligilble_rental_income" readonly="">
    </div>
  ...
  <div class="row" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required other_monthy" value="0" id="other_monthy" name="other_monthy">
     </div>
   ...
   <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required eligilble_other_income" value="0" id="eligilble_rental_income" name="eligilble_other_income" readonly="">
    </div>
  ...
  <div class="row" id="input_fields_wrap">
    <div class="col-md-12" style="display: inline-flex;padding: 0px;">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control required loan_amount" value="0" id="loan_amount" name="loan_amount[]">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control required o_s_balance" value="0" id="o_s_balance" name="o_s_balance[]">
        </div>
...
<div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 30px">
  ...
  <div class="col-md-12" > 
    ...
    <div class="col-sm-4">
     ...
     <div class="col-md-12" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control total_monthly_gross_income" id="total_monthly_gross_income" value="0" name="total_monthly_gross_income" readonly="">
     </div>
   ...
   <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required new_deduction" id="new_deduction" value="0" name="new_deduction" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required net_income_after_tax" value="0" id="net_income_after_tax" name="time_period" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required other_emi" value="0" id="other_emi" name="other_emi" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required net_income_deduction" value="0" id="net_income_deduction" name="net_income_deduction" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required 40_gross_income" value="0" id="40_gross_income" name="time_period" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required total_disposal_income" value="0" id="total_disposal_income time_period" name="time_period" readonly="">
    </div>
...
<div class="col-sm-4">
  ...
  <div class="col-md-12 average_itr_hidden" > 
    <div class="form-group">
     ...
     <input type="text" class="form-control total_monthly_gross_income_two" id="total_monthly_gross_income" value="0" name="total_monthly_gross_income" readonly="">
   </div>
 ...
 <div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required new_deduction_two" id="deduction" value="0" name="deduction" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required net_income_after_tax_two" value="0" id="net_income_after_tax" name="time_period" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required other_emi_two" value="0" id="other_emi" name="other_emi" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required net_income_deduction_two" value="0" id="net_income_deduction" name="net_income_deduction" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required 40_gross_income_two" value="0" id="40_gross_income" name="time_period" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required total_disposal_income_two" value="0" id="total_disposal_income time_period" name="time_period" readonly="">
  </div>
 ...
 <div class="col-lg-12 col-md-12 col-sm-6">
  ...
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control reverse_loan_amount_rs" id="loan_amount_rs" value="0" name="reverse_loan_amount_rs" readonly="">
     </div>
  ...
  <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required reverse_emi_amount" value="0" id="total_disposal_income_two" name="final_emi" readonly="">
    </div>
...
<div class="col-lg-12">
 ...
 <div class="col-md-12" > 
     ...
     <div class="col-md-12" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required quantam_applicant_one" value="0" id="quantam_applicant_one" name="quantam_applicant_one" readonly="">
     </div>
   ...
   <div class="col-md-12" > 
    <div class="form-group">
     ...
     <input type="text" class="form-control required quantam_applicant_two" value="0" id="quantam_applicant_two" name="quantam_applicant_two" readonly="">
   </div>
 ...
 <div class="col-md-12" > 
  <div class="form-group">
   ...
   <input type="text" class="form-control required quantam_applicant_three" value="0" id="quantam_applicant_three" name="quantam_applicant_three" readonly="">
 </div>
...
<div class="col-md-12" > 
  <div class="form-group">
   ...
   <input type="text" class="form-control required max_quantom_loan_home" value="0" id="max_quantom_loan_home" name="max_quantom_loan_home" readonly="">
 </div>
 ...
 <div class="col-md-12" > 
    ...
    <div class="col-md-12" > 
      <div class="form-group">
        ...
        <input type="text" class="form-control required maximum_age_month" value="0" id="maximum_age_month" name="maximum_age_month" readonly="">
      </div>
   ...
   <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required max_eligibile_term_month" value="0" id="max_eligibile_term_month" name="max_eligibile_term_month" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required max_eligibile_term_relax" value="0" id="max_eligibile_term_relax" name="max_eligibile_term_relax" readonly="">
    </div>
...
<div class="col-lg-12 col-md-12 col-sm-6">
  ...
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required interest_rate" value="0" id="interest_rate" name="interest_rate">
     </div>
   ...
   <div class="col-md-6" > 
    <div class="form-group">
     ...
     <input type="text" class="form-control required number_of_month" value="0" id="number_of_month" name="number_of_month">
   </div>
 ...
 <div class="col-md-6" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required emi_per_lakh" value="0" id="emi_per_lakh" name="emi_per_lakh" readonly="">
  </div>
...
<div class="col-md-6" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required eligilble_as_per_average_income" value="0" id="eligilble_as_per_average_income" name="eligilble_as_per_average_income" readonly="">
  </div>
...
<div class="col-md-6" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required eligilble_as_per_latest" value="0" id="number_of_month" name="eligilble_as_per_latest" readonly="">
  </div>
...
<div class="col-lg-12 col-md-12 col-sm-6">
 ...
 <div class="row move-right" >
  ...
  <div class="col-md-6" > 
    <div class="form-group">
     ...
     <input type="text" class="form-control required ltv_mkt_property" value="0" id="ltv_mkt_property" name="ltv_mkt_property">
   </div>
 ...
 <div class="col-md-6" > 
  <div class="form-group">
   ...
   <input type="text" class="form-control required ltv_cost_of_project" id="ltv_cost_of_project" value="0" name="ltv_cost_of_project">
 </div>
...
<div class="col-md-6" > 
  <div class="form-group">
   ...
   <input type="text" class="form-control required ltv_loan_amount_applied" value="0" id="ltv_loan_amount_applied" name="ltv_loan_amount_applied">
 </div>
...
<div class="col-md-6" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required value_to_be_consider" value="0" id="value_to_be_consider" name="value_to_be_consider" readonly="">
  </div>
  ...
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
        ...
        <input type="text" class="form-control required value_to_be_consider_two" value="0" id="property_value" name="value_to_be_consider_two" readonly="">
      </div>
    ...
    <div class="col-md-6" > 
      <div class="form-group">
        ...
        <input type="text" class="form-control required ltv_takeover_two" value="0" id="balance_home_loan_account" name="ltv_takeover_two" readonly="">
      </div>
  ...
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
        ...
        <input type="text" class="form-control required maximum_eligible_loan_average" value="0" id="maximum_eligible_loan_average" name="maximum_eligible_loan_average" readonly="">
      </div>
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required maximum_eligible_loan_year_month" value="0" id="maximum_eligible_loan_year_month" name="maximum_eligible_loan_year_month" readonly="">
     </div>
...
<div class="col-lg-12 col-md-12 col-sm-6">
  ...
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control loan_amount_rs" id="loan_amount_rs" value="0" name="loan_amount_rs">
     </div>
   ...
   <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required interest" id="interest" value="0" name="interest">
    </div>
  ...
  <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required time_period" value="0" id="number_of_month time_period" name="time_period">
    </div>
  ...
  <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required final_emi" value="0" id="final_emi time_period" name="final_emi" readonly="">
    </div>
...
$('.year_one_check').on("click",function(){
    
 $('input').val(0);
});

$('.year_two_check').on("click",function(){
    
 $('input').val(0);

});

$('.year_three_check').on("click",function(){
...
$('.month_one_check').on("click",function(){
    
 $('input').val(0);
});

$('.month_two_check').on("click",function(){
    
 $('input').val(0);

});

$('.month_three_check').on("click",function(){
    
 $('input').val(0);
});

$('.month_four_check').on("click",function(){
    
 $('input').val(0);
});
$('.month_five_check').on("click",function(){
    
 $('input').val(0);
});

$('.month_six_check').on("click",function(){
...
var reverse_emi_calculation_top=Math.pow(1+parseFloat(reverse_interest_month),max_eligibile_term_month)-1;

var reverse_emi_calculation_bottom=Math.pow(1+parseFloat(reverse_interest_month),max_eligibile_term_month);
...
console.log("dsdf"+maximum_eligible_loan);
console.log("dsdf"+eligilble_as_per_average_income);
console.log("dsdf"+ltv_loan_amount_applied);
