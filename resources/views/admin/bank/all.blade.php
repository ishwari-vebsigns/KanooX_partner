      ...
      "columns":[{
        ...
        {  
          ...
          "mRender": function(data, type, row){
            ...
            // }else{
              //return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/bank/" + row.bank_id+"><span><button type='submit' class='btn btn-primary'>Edit</button></span></a> ";
              return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/bank/" + row.bank_id+"><span><button type='submit' class='btn btn-primary'>Edit</button></span></a> <a class=datatable-left-link href={{config('app.baseURL')}}/admin/bank/active/" + row.bank_id+"><span><button type='submit' class='btn btn-success'>Delete</button></span></a>";
            }
          },
