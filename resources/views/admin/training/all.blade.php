            ...
            <div class="container-fluid">
                ...
                <div class="row">
                 ...
                 <P></P>              <h4 class="card-title">
                    ...
                    <a href="add" style="color:white;" class="btn btn-secondary">Add Training</a>
                    @endif
        ...
        columns: [
           ...
           
            {
                ...
                render: function(data, type, row) {
                    ...
                    @if($my_permissions->contains('TRAINING_DETAILS'))
                        return '<a type="button" href="' + data.training_id + '" class="btn btn-dark">Details</a>'
                    @endif
