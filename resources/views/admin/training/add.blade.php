...
<div class="content-body">
            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{$base_url}}/admin/training/all">Training</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Training URL</a></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Traing URL</h4>
                            </div>
                            <div class="card-body"> 
                                            ...
                                            <div class="col-xl-10">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 {{ $errors->has('training_name') ? ' has-error' : '' }}">
                                                        <input type="text" class="form-control" id="training_name" name="training_name" placeholder="Training Name " required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 {{ $errors->has('training_url') ? ' has-error' : '' }}">
                                                        <input type="text" class="form-control" id="training_url" name="training_url" placeholder="Please enter only URL Code" required>
