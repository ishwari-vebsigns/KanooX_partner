                                ...
                                <div class="post-content">
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                          ...
                                          <div class="job-location me-lg-3 me-2"><h6>Dully filled Application Form with Photograph :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/storage/app/{{$loans_dully->documents}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                 ...
                                 <div class="post-content">
                                     <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/storage/app/{{$loans_identity->documents}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                    ...
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                      ...
                                      <div class="job-location me-lg-3 me-2"><h6>Educational Qualification Proof - Latest Degree (for professionals) :</h6><br>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/storage/app/{{$loans_edu->documents}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                 ...
                                 <div class="post-content">
                                   <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                         ...
                                         <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/storage/app/{{$loans_business->documents}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                 ...
                                 <div class="post-content">
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/storage/app/{{$loans_tax->documents}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                 ...
                                 <div class="post-content">
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/storage/app/{{$loans_bank->documents}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>                                
                                </div><br>
                                       @endforeach
                                    </div>
                                ...
                                @if($loan_residence!="")
                                    ...
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/storage/app/{{$loans_residence->documents}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>                               
                                </div><br>
                                       @endforeach
                                    </div>
                                  ...
                                  <div class="post-content">
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/storage/app/{{$loans_salary->documents}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>                                  
                                </div><br>
                                       @endforeach
                                    </div>
                                ...
                                <div class="post-content">
                                   <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/storage/app/{{$loans_formsix->documents}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>                                   
                                </div><br>
                                       @endforeach
                                          </div>
