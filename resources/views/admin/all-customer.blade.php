...
<script>
    $(document).ready(function() {
        ...
        function SaleByProductData() {
            ...
            $.ajax({
                url: '{{$base_url}}/admin/all-customers/alldata?date_from=' + date_from + "&date_to=" + date_to,
                method: 'GET',
         ...
         function convertToExcel() {
           ...
           function downloadExcel() {
              ...
              if (!isDownloaded) {
                ...
                a.download = 'all-customers-' + currentPage + '.xlsx';
                a.click();
        ...
        $(".export-button").click(function() {
            ...
            $("#export-form").attr('action', "{{$base_url}}/admin/all-customers/alldata?date_from=" + date_from + "&date_to=" + date_to);
            $("#export-form").submit();
        });
    });
</script>
