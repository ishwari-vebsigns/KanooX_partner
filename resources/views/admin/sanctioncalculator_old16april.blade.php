  ...
  <div class="content-wrapper">
            ...
            <div class="card">
              ...
              <div class="card-content business">
                <div class="card-body">
                  ...
                  <span>Year 1 <input type="checkbox" name="year_one" checked=""></span>
                  <span> Year 2 <input type="checkbox" name="year_two" checked=""></span>
                  <span>Year 3 <input type="checkbox" name="year_three" checked=""></span>
                  ...
                  <form class="form-horizontal" role="form" method="POST" action="add" enctype="multipart/form-data" novalidate="">
                   ...
                   <div class="col-lg-2 col-md-2 col-sm-2 {{ $errors->has('age') ? ' has-error' : '' }}">
                    <div class="form-group">
                      <div class="controls">
                        <label class="label" for="">Name</label>
                        <input class="form-control name" required="" value="Nitish Anand" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Name">
                        @if ($errors->has('name'))
                  ...
                  <div style="display: inline-flex;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                      <div class="form-group">
                        <div class="controls">
                          <label class="label" for="">Date of Birth</label>
                          <input class="form-control date_of_birth" required="" data-validation-required-message="This field is required" type="date" name="" value="" placeholder="Date of Birth">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('age') ? ' has-error' : '' }}">
                      <div class="form-group">
                        <div class="controls">
                          <label class="label" for="">Age (In Years)</label>
                          <input class="form-control age" required="" value="0" data-validation-required-message="This field is required" type="number" name="" value="0" placeholder="Age">
                          @if ($errors->has('age'))
                          <span class="help-block">
                ...
                <!--           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label" for="">Agriculture Income</label>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label" for="">Other Income</label>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label" for="">Depreciation</label>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label" for="">Total Gross Income</label>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label" for="">Tax</label>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label" for="">Total Deduction</label>
    ...
    <div class="card-content working hidden">
      <div class="card-body">
        ...
        <form class="form-horizontal working" role="form" method="POST" action="add" enctype="multipart/form-data" novalidate="">
          <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">                        
          <div class="contact-form">
            <div class="row">
             ...
             <div class="col-md-10">
              ...
              <!--   <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      <label class="label" for="">Gross Income</label>
                      <input class="form-control one_salary_gross_income" required="" data-validation-required-message="This field is required" type="number" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      <label class="label" for="">Net Monthly Income</label>
              ...
              <div class="col-md-2">
                <h6 class="card-title" style="text-align: center;">6 Month (Latest)</h6>
          ...
          <div class="col-md-2">
            <h6 class="card-title" style="text-align: center;">Average Monthly Income</h6>
          ...
          <div class="card-header existing_loan_co hidden">
            <h6 class="card-title">Co-Borrower</h6>
          </div><br>

          <br> <div class="row existing_loan_co hidden">
...
<div class="col-lg-12 col-md-12 col-sm-12">
  <h5>Disposal Income Calculation </h5>
  <br>
  <div class="row" >
    <div class="col-sm-6">
     <h5>As per latest ITR & salary </h5>
     <div class="col-md-12" > 
      <div class="form-group">
...
<div class="col-sm-6">
  <h5>average of Three ITR & 6 Month salary </h5>
  <div class="col-md-12" > 
    <div class="form-group">
...
<div class="col-lg-12">
  ...
  <div class="row">
   ...
   <div class="col-lg-6">
    <h5>Maximum Quantam Eligibility</h5>
    <div class="row" >
...
<div class="col-lg-6">
  <h5>Maximum Term Eligibility</h5>
  <div class="row" >
...
<div class="col-lg-12 col-md-12 col-sm-6">
  <h5>Eligibility as per repayment capacity</h5>
  <div class="row" >
...
<div class="col-lg-12 col-md-12 col-sm-6">
  <h5>Eligible Home Loan Amount</h5>
  <div class="row" >
...
<div class="col-lg-12 col-md-12 col-sm-6">
 <h5>Maximum Term HOME LOAN PLUS </h5>
 <div class="row" >
  ...
  $(document).ready(function() {
    ...
    $("#add_field_button").click(function(e){ 
      ...
      if(x < max_fields){ 
        ...
        $("#input_fields_wrap").append("<div class='col-md-12' style='display: inline-flex;padding: 0px;'><div class='col-md-10' ><div class='form-group'><label for='proposalTitle3'></label><input type='number' value='0' class='form-control required running_emi"+x
          +"' id='proposalTitle3' name='emi[]'></div></div><br><a class='btn btn btn-outline-primary btn-sm dlt btn-align' style='height:40px;margin-top:1.5%;'><i class='fa fa-minus'></i></a></div>");
      }
...
$('input').keyup(function(){
 ...
 var eligilble_rental_income=parseFloat(future_rental)*60/100;
 ...
 $('.eligilble_other_income').val(eligilble_other_income);
    ...
    // if (profession_type=="self") {
     ...
     $('.co_one_net_montly_income').val(co_one_net_montly_income);
      ...
      var average_salary_gross_income=(parseFloat(one_salary_gross_income)+parseFloat(two_salary_gross_income)+parseFloat(three_salary_gross_income)+parseFloat(four_salary_gross_income)+parseFloat(five_salary_gross_income)+parseFloat(six_salary_gross_income))/6;
      
      var average_salary_tax=(parseFloat(one_salary_tax)+parseFloat(two_salary_tax)+parseFloat(three_salary_tax)+parseFloat(four_salary_tax)+parseFloat(five_salary_tax)+parseFloat(six_salary_tax))/6;

      var average_salary_deduction=(parseFloat(one_salary_deduction)+parseFloat(two_salary_deduction)+parseFloat(three_salary_deduction)+parseFloat(four_salary_deduction)+parseFloat(five_salary_deduction)+parseFloat(six_salary_deduction))/6;


      var average_net_montly_income=(parseFloat(one_net_montly_income)+parseFloat(two_net_montly_income)+parseFloat(three_net_montly_income)+parseFloat(four_net_montly_income)+parseFloat(five_net_montly_income)+parseFloat(six_net_montly_income))/6;
      ...
      var co_average_salary_gross_income=(parseFloat(co_one_salary_gross_income)+parseFloat(co_two_salary_gross_income)+parseFloat(co_three_salary_gross_income)+parseFloat(co_four_salary_gross_income)+parseFloat(co_five_salary_gross_income)+parseFloat(co_six_salary_gross_income))/6;
      
      var co_average_salary_tax=(parseFloat(co_one_salary_tax)+parseFloat(co_two_salary_tax)+parseFloat(co_three_salary_tax)+parseFloat(co_four_salary_tax)+parseFloat(co_five_salary_tax)+parseFloat(co_six_salary_tax))/6;
      var co_average_salary_deduction=(parseFloat(co_one_salary_deduction)+parseFloat(co_two_salary_deduction)+parseFloat(co_three_salary_deduction)+parseFloat(co_four_salary_deduction)+parseFloat(co_five_salary_deduction)+parseFloat(co_six_salary_deduction))/6;


      var co_average_net_montly_income=(parseFloat(co_one_net_montly_income)+parseFloat(co_two_net_montly_income)+parseFloat(co_three_net_montly_income)+parseFloat(co_four_net_montly_income)+parseFloat(co_five_net_montly_income)+parseFloat(co_six_net_montly_income))/6;
...
var self_other_ded_year_three=$(".self_other_ded_year_three").val();
  ...
  var self_latest_monthly_average_ded=parseFloat(self_other_ded_year_three)/12;
   ...
   var self_all_monthly_average_gross=(parseFloat(self_gross_income_year_one)+parseFloat(self_gross_income_year_two)+parseFloat(self_gross_income_year_three))/36;

   console.log(self_all_monthly_average_gross);
   var self_all_monthly_average_agriculture=(parseFloat(self_agriculture_income_year_one)+parseFloat(self_agriculture_income_year_two)+parseFloat(self_agriculture_income_year_three))/36;
   var self_all_monthly_average_other_income=(parseFloat(self_other_income_year_one)+parseFloat(self_other_income_year_two)+parseFloat(self_other_income_year_three))/36;
   var self_all_monthly_average_depreciation=(parseFloat(self_depreciation_year_one)+parseFloat(self_depreciation_year_two)+parseFloat(self_depreciation_year_three))/36;

   var self_all_monthly_average_tax=(parseFloat(self_tax_year_one)+parseFloat(self_tax_year_two)+parseFloat(self_tax_year_three))/36;
   var self_all_monthly_average_ded=(parseFloat(self_other_ded_year_one)+parseFloat(self_other_ded_year_two)+parseFloat(self_other_ded_year_three))/36;
...
var co_self_other_ded_year_three=$(".co_self_other_ded_year_three").val();
  ...
  var co_self_latest_monthly_average_ded=parseFloat(co_self_other_ded_year_three)/12;
   ...
   var co_self_all_monthly_average_gross=(parseFloat(co_self_gross_income_year_one)+parseFloat(co_self_gross_income_year_two)+parseFloat(co_self_gross_income_year_three))/36;

   console.log(co_self_all_monthly_average_gross);
   var co_self_all_monthly_average_agriculture=(parseFloat(co_self_agriculture_income_year_one)+parseFloat(co_self_agriculture_income_year_two)+parseFloat(co_self_agriculture_income_year_three))/36;
   var co_self_all_monthly_average_other_income=(parseFloat(co_self_other_income_year_one)+parseFloat(co_self_other_income_year_two)+parseFloat(co_self_other_income_year_three))/36;
   var co_self_all_monthly_average_depreciation=(parseFloat(co_self_depreciation_year_one)+parseFloat(co_self_depreciation_year_two)+parseFloat(co_self_depreciation_year_three))/36;

   var co_self_all_monthly_average_tax=(parseFloat(co_self_tax_year_one)+parseFloat(co_self_tax_year_two)+parseFloat(co_self_tax_year_three))/36;
   var co_self_all_monthly_average_ded=(parseFloat(co_self_other_ded_year_one)+parseFloat(co_self_other_ded_year_two)+parseFloat(co_self_other_ded_year_three))/36;
...
var co_self_total_deduction_year_three_average=parseFloat(co_self_latest_monthly_average_tax)+parseFloat(co_self_latest_monthly_average_ded);
  ...
  if (parseFloat(total_monthly_gross_income)<parseFloat(amount_condition)) {
    var gross_income_fourty=parseFloat(total_monthly_gross_income)*40/100;
  }else{
  ...
  if (parseFloat(total_monthly_gross_income_two)<parseFloat(amount_condition)) {
    var gross_income_fourty_two=parseFloat(total_monthly_gross_income_two)*40/100;
  }else{
...
if (value_to_be_consider<=3333333) {
  ...
  var value_to_be_consider_two=parseFloat(value_to_be_consider)*(90/100);

}else if(value_to_be_consider>333333 && value_to_be_consider<10000000){

  var value_to_be_consider_two=parseFloat(value_to_be_consider)*(80/100);

}else if(value_to_be_consider>=10000000){

 var value_to_be_consider_two=parseFloat(value_to_be_consider)*(75/100); 
...
// }
  ...
  $('.existing_loan_co').change(function(){
    ...
    if($(this).is(':checked')){
     $('.existing_loan_co').removeClass('hidden');
   }
   else
   {
    $('.existing_loan_co').addClass('hidden');
  }    
