 ...
 -->
            ...
            <div class="card-header existing_loan hidden">
                      <div class="col-md-12" style="padding-top: 20px;padding-bottom: 20px;">
                <div class="form-check form-check-inline me-5  selfTab">
                  <input class="form-check-input" type="radio" name="profession_type" id="selfTab" checked="" value="self" onclick="show3();">
                  <label class="form-check-label" for="self"><b style="font-size: 16px;">Self Employed/ Business Professionals</b></label>
                </div>
                <div class="form-check form-check-inline active me-5">
                  <input class="form-check-input" type="radio" name="profession_type" id="salariedTab"  value="salaried" onclick="show4();">
                  <label class="form-check-label" for="married"><b style="font-size: 16px;">Salaried Employees</b> </label>
                </div>
              </div>
              <br>
            ...
            <br> <div class="row existing_loan hidden">
              ...
              <br>
               <div class="col-md-12" style="margin-left: 12px;width: 150%;max-width: 113%;">
                          ...
                          <div class="card-header existing_loan1 hidden">
                                    <div class="col-md-12" style="padding-top: 20px;padding-bottom: 20px;">
                <div class="form-check form-check-inline me-5  selfTab">
                  <input class="form-check-input" type="radio" name="profession_type" id="selfTab" checked="" value="self" onclick="show5();">
                  <label class="form-check-label" for="self"><b style="font-size: 16px;">Self Employed/ Business Professionals</b></label>
                </div>
                <div class="form-check form-check-inline active me-5">
                  <input class="form-check-input" type="radio" name="profession_type" id="salariedTab"  value="salaried" onclick="show6();">
                  <label class="form-check-label" for="married"><b style="font-size: 16px;">Salaried Employees</b> </label>
                </div>
              </div>
              <br>
                            <h6 class="card-title">Co-Applicant1</h6>
                          </div><br>
                          ...
                          <div class="row existing_loan1 hidden col-md-12" style="flex-wrap: wrap;margin-right: -14px;margin-left: 0px!important;padding-right: 0px!important;padding-left: 14px!important;flex: 0 0 103%!important;max-width: 135%!important;">
              ...
              <div class="col-md-12" style="margin-left: 12px;width: 150%;max-width: 113%;">
                <label class="label" for="existing"><input type="checkbox" value="2" class="existing_loan_check2" name="existing_loan_check1"> &nbsp; <b style="font-size: 16px;">Co Applicant2</b> </label>
              </div>

              <div class="card-header existing_loan2 hidden">
                        <div class="col-md-12" style="padding-top: 20px;padding-bottom: 20px;">
                <div class="form-check form-check-inline me-5  selfTab">
                  <input class="form-check-input" type="radio" name="profession_type" id="selfTab" checked="" value="self" onclick="show7();">
                  <label class="form-check-label" for="self"><b style="font-size: 16px;">Self Employed/ Business Professionals</b></label>
                </div>
                <div class="form-check form-check-inline active me-5">
                  <input class="form-check-input" type="radio" name="profession_type" id="salariedTab"  value="salaried" onclick="show8();">
                  <label class="form-check-label" for="married"><b style="font-size: 16px;">Salaried Employees</b> </label>
                </div>
              </div>
              <br>
                <h6 class="card-title">Co-Applicant2</h6>
              </div><br>

              <div class="col-md-12 businessco2applicant existing_loan2 hidden" style="padding-top: 20px;padding-bottom: 20px;">
              ...
              <div class="row existing_loan2 hidden col-md-12" style="flex-wrap: wrap;padding-right: 0px!important;padding-left: 3px!important;flex: -1 0 101%!important;max-width: 135%!important;margin-right: -14px;margin-left: 0px!important;">
                            <div class="row col-md-2">
                        <h6 class="card-title" style="text-align: center; visibility: hidden;">Year 1</h6>
        ...
        <!-- <form class="form-horizontal working" role="form" method="POST" action="#" enctype="multipart/form-data" novalidate=""> -->
          ...
          <div class="card-header existing_loan_co_check2 hidden">
            <h6 class="card-title">Co-Borrower2</h6>
              ...
              <div class="row" style="margin-right: 0px!important;margin-left: -3px!important;">          
                <div class="col-md-2" style="padding-left: 15px !important;padding-right: 15px !important;">
            <h6 class="card-title" style="text-align: center;visibility: hidden;">Average</h6>
...
//coapplicanttwo
 function show7() {
  ...
  $('.workingco2applicant').addClass('hidden');
  $('.businessco2applicant').removeClass('hidden');
...
function show8() {
  ...
  $('.businessco2applicant').addClass('hidden');
  $('.workingco2applicant').removeClass('hidden');
  var radioButton = document.getElementById("selfTab");
  radioButton.checked = false;
