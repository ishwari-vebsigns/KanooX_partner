          ...
          <!-- <form class="form-horizontal" role="form" method="" action="" enctype="multipart/form-data" novalidate=""> -->
            ...
            <div class="contact-form">
              <div class="row">
                ...
                <div class="col-md-4 {{ $errors->has('loan_type') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('loan_amount') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('full_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 {{ $errors->has('residence_address') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('firm_company_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('work_experience') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('nature_of_work') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('business_estabish_date') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('qualification') ? ' has-error' : '' }}">
            ...
            <!--     <div class="col-md-4 {{ $errors->has('mobile') ? ' has-error' : '' }}">
              ...
              <div class="row col-md-12">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-4 {{ $errors->has('exist_loan_type') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('exist_loan_amount') ? ' has-error' : '' }}">
                  <label class="margin-label">Loan Amount</label>
                  <div class="form-group">
                    <div class="controls">
                ...
                <div class="col-md-4 {{ $errors->has('exist_tenor_of_loan') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('exist_emi') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('exist_sanction_dt') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('exist_emi_bounce') ? ' has-error' : '' }}">
                ...
                <div class="col-md-4 {{ $errors->has('extra_income') ? ' has-error' : '' }}">
                                ...
                                <div class="post-content">
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                          ...
                                          <div class="job-location me-lg-3 me-2"><h6>Dully filled Application Form with Photograph :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h6>
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/admin/delete_document/{{$loans_dully->loan_doc_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                 ...
                                 <div class="post-content">
                                     <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/admin/delete_document/{{$loans_identity->loan_doc_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                    ...
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                      ...
                                      <div class="job-location me-lg-3 me-2"><h6>Educational Qualification Proof - Latest Degree (for professionals) :</h6><br>
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/admin/delete_document/{{$loans_edu->loan_doc_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                 ...
                                 <div class="post-content">
                                   <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                         ...
                                         <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/admin/delete_document/{{$loans_business->loan_doc_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                 ...
                                 <div class="post-content">
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/admin/delete_document/{{$loans_tax->loan_doc_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>
                                 ...
                                 <div class="post-content">
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/admin/delete_document/{{$loans_bank->loan_doc_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>                                
                                </div><br>
                                       @endforeach
                                    </div>
                                ...
                                @if($loan_residence!="")
                                    ...
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/admin/delete_document/{{$loans_residence->loan_doc_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>                               
                                </div><br>
                                       @endforeach
                                    </div>
                                  ...
                                  <div class="post-content">
                                    <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/admin/delete_document/{{$loans_salary->loan_doc_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>                                  
                                </div><br>
                                       @endforeach
                                    </div>
                                ...
                                <div class="post-content">
                                   <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-md-1 col-sm-1 col-2">
                                               <a href="{{config('app.baseURL')}}/admin/delete_document/{{$loans_formsix->loan_doc_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                           </div>                                   
                                </div><br>
                                       @endforeach
                                          </div>
                              ...
                              <div class="card" style="padding:10px;border:1px solid #ddd;width:70%;">
                                <div class="job-location me-lg-3 me-2"><h6>Comments </h6>
                                  ...
                                  @endphp
                                    ...
                                    @foreach($loandetails->comments as $cmt)
                                    @php
                                  ...
                                  <div class="card" style="margin-left:15px;padding:10px;border:2px solid #ddd;width:95%;margin-top: -7px;">
                                   ...
                                   @if($cmts->attachment!='')
                                    ...
                                    <div class="col-md-1 col-sm-1 col-2">
                                      <a href="{{config('app.baseURL')}}/admin/deletecomment/{{$cmts->comment_id}}"><img src="{{config('app.baseURL')}}/assets/img/apply-loan/delete_loan.png" alt="img" style="width: 27px;height: 28px;" /></a>
                                    </div>
                ...
                <!-- Comments -->
                <div>
                  <form action="{{config('app.baseURL')}}/admin/sendcomment" method="POST" enctype="multipart/form-data">
                  @csrf
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{config('app.baseURL')}}/admin/loaninprocess/{{$loandetails->loan_id}}" method="POST" id="userForm">
        @csrf
        <input type="hidden" name="loan_id" value="{{$loandetails->loan_id}}">
          <label>Sub Status</label>
          <select class="form-control" name="status_id" required>
            @foreach($loanstatus as $loansstatus)
              <option value="{{$loansstatus->status_id}}">{{$loansstatus->status_name}}</option>
            @endforeach
          </select>
          <label>Comment</label>
