                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_gross_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_total_gross_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_gross_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_gross_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_gross_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_gross_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_gross_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_gross_year_one" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_gross_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_gross_year_two" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_gross_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_gross_year_three" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control one_salary_gross_income" id="demo" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control two_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control three_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control four_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control five_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control six_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control average_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_one_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_two_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_three_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_four_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_five_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_six_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_average_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="" value="0" placeholder="Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
