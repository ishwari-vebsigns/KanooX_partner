...
<script>
  $(function(){
    $("#footer-table").DataTable({
      ...
      "ajax": "{{config('app.baseURL')}}/admin/partner/allData",
      ...
      
      {
        ...
        "targets":-1,
          ...
          "ilter":false,
          "mRender": function(data, type, row){
            return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/partner/partnerloan/all/" + row.id+"><span><button type='submit' class='btn btn-primary mr-1'>Loan Applications</button></span></a>";
          },
      },
