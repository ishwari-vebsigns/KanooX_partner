  ...
  $(function(){
    $("#footer-table").DataTable({
      ...
      "columns":[{
          ...
          "mRender": function(data, type, row){
            // if(row.is_active==0){
            //    return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/admin/" + row.id+"><span><button type='submit' class='btn btn-primary'>Details</button></span></a> ";
            ...
            // }else{
               // return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/admin/" + row.id+"><span><button type='submit' class='btn btn-primary'>Details</button></span></a> ";
            return "<a class=datatable-left-link href={{config('app.baseURL')}}/admin/admin/" + row.id+"><span><button type='submit' class='btn btn-primary'>Details</button></span></a> <a class=datatable-left-link href={{config('app.baseURL')}}/admin/delete/" + row.id+"><span><button type='submit' class='btn btn-danger'>Delete</button></span></a>";
            // }
          },
