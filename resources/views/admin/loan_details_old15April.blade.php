        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title no-print">Loan</h4>
            </div>
            <div class="card-content">
              <div class="card-body">
                <p class="mt-1 no-print">All <code>Loan</code></p>
              <!-- <form class="form-horizontal" role="form"> -->
                
                
              <div class="row col-lg-12 col-md-12 col-sm-6 no-print"> 
                <?php
          ...
          <!-- <form class="form-horizontal" role="form" method="" action="" enctype="multipart/form-data" novalidate=""> -->
            ...
            <div class="contact-form">
              <div class="row">
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('loan_type') ? ' has-error' : '' }}">
                  <label class="margin-label">Loan Type (In year)</label>
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('loan_amount') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('full_name') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('residence_address') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('office_address') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('firm_company_name') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('work_experience') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('nature_of_work') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('business_estabish_date') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('qualification') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('email') ? ' has-error' : '' }}">
               ...
               <div class="col-lg-6 col-lg-6 col-sm-6 {{ $errors->has('mobile') ? ' has-error' : '' }}">
              ...
              <div class="row col-lg-12 col-md-12 col-sm-6">
                ...
                <div class="col-lg-12 col-md-12 col-sm-6">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('exist_loan_type') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('exist_loan_amount') ? ' has-error' : '' }}">
                  <label class="margin-label">Loan Amount</label>
                  <div class="form-group">
                    <div class="controls">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('exist_tenor_of_loan') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('exist_emi') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('exist_sanction_dt') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('exist_emi_bounce') ? ' has-error' : '' }}">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('extra_income') ? ' has-error' : '' }}">
                             ...
                             <div class="single-job-post me-1 wow fadeInUp mt-25" data-wow-delay="0.3s">
                               ...
                               @endphp
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->dully_filled}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->dully_filled}}" class="btn btn-success" >view</a>
                                </div><br>
                                 ...
                                 <div class="post-content">
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->ageproof}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->ageproof}}" class="btn btn-success" >view</a>
                                </div><br>
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->education}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->education}}" class="btn btn-success" >view</a>
                                </div><br>
                                 ...
                                 <div class="post-content">
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->business_certificate}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->business_certificate}}" class="btn btn-success" >view</a>
                                </div><br>
                                 ...
                                 <div class="post-content">
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->tax_return}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->tax_return}}" class="btn btn-success" >view</a>
                                </div><br>
                                @endif
                                 ...
                                 <div class="post-content">
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->bank_statement}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->bank_statement}}" class="btn btn-success" >view</a>
                                </div><br>
                                 ...
                                 <div class="post-content">
                                    <div class="">
                                     ...
                                     <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->cheque}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->cheque}}" class="btn btn-success" >view</a>
                                </div><br>
                                 ...
                                 <div class="post-content">
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->property_document}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->property_document}}" class="btn btn-success" >view</a>
                                </div><br>
                                ...
                                @if($loandetails->profession_type!="salaried")
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->resident_proof}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->resident_proof}}" class="btn btn-success" >view</a>
                                </div><br>
                                @endif
                                 ...
                                 @if($loandetails->profession_type=="salaried")
                                  ...
                                  <div class="post-content">
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->salary_slip}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->salary_slip}}" class="btn btn-success" >view</a>
                                </div><br>
                                  ...
                                  <div class="post-content">
                                    ...
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->form_sixteen}}" class="btn btn-primary" download>Download</a>&nbsp;&nbsp;
                                    <a href="{{config('app.baseURL')}}/storage/app/{{$loan_doc->form_sixteen}}" class="btn btn-success" >view</a>
                                </div><br>
                                @endif
                ...
                @if($loandetails->note!= '')
                <div class="col-lg-6 col-md-6 col-sm-6 {{ $errors->has('note') ? ' has-error' : '' }}">
