                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    @endif
                                                    @if($agent->kyc_status==0 && $agent->video_kyc==null)
                                                        
                                                    <input type="file" class="form-control" accept="video/*" id="val-range" name="kyc_video">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    ...
                                                    @if($agent->kyc_status==1 || $agent->aadhar_front!=null)
                                                        <div class="col-md-12 p-0 product-div">
                                                            <iframe width="300" height="200" src="{{$base_url}}/storage\app/{{$agent->aadhar_front}}">
                                                            </iframe>
                                                          {{-- <img class="img-fluid" src="{{$base_url}}/storage\app/{{$agent->aadhar_front}}" id="current_product_image" style=" margin:auto;max-height:200px;max-width:200px;" onerror="this.src='{{$base_url}}/web-assets/images/resources/product.png';"> --}}
                                                        </div>
                                                    @endif
                                                    @if($agent->kyc_status==0 && $agent->aadhar_front==null)
                                                        
                                                        <input type="file" class="form-control" accept="image/*" id="val-range" name="aadhar_front">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    @if($agent->kyc_status==1 || $agent->aadhar_back!=null)
                                                        <div class="col-md-12 p-0 product-div">
                                                            <iframe width="300" height="200" src="{{$base_url}}/storage\app/{{$agent->aadhar_back}}">
                                                            </iframe>
                                                          {{-- <img class="img-fluid" src="{{$base_url}}/storage\app/{{$agent->aadhar_back}}" id="current_product_image" style=" margin:auto;max-height:200px;max-width:200px;" onerror="this.src='{{$base_url}}/web-assets/images/resources/product.png';"> --}}
                                                        </div>
                                                    @endif
                                                    @if($agent->kyc_status==0 && $agent->aadhar_back==null)
                                                        <input type="file" class="form-control" id="val-range" accept="image/*" name="aadhar_back">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        @if($agent->kyc_status==1 || $agent->pan_card!=null)
                                                            <div class="col-md-12 p-0 product-div">
                                                                <iframe width="300" height="200" src="{{$base_url}}/storage\app/{{$agent->pan_card}}" onerror="this.src='{{$base_url}}/web-assets/images/resources/product.png';">
                                                                </iframe> 
                                                              {{-- <img class="img-fluid" src="{{$base_url}}/storage\app/{{$agent->pan_card}}" id="current_product_image" style=" margin:auto;max-height:200px;max-width:200px;" onerror="this.src='{{$base_url}}/web-assets/images/resources/product.png';"> --}}
                                                            </div>
                                                        @endif
                                                        @if($agent->kyc_status==0 && $agent->pan_card==null)
                                                            <input type="file" class="form-control" id="val-range" accept="image/*" name="pan_card">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-10 form-group ml-3">
                                                        ...
                                                        <button name="reject_kyc" class="btn btn-danger">Reject KYC</button>
                                                        @endif
