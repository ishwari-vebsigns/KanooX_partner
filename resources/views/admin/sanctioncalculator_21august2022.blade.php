...
.menu-shadow, .header-navbar-shadow, .header-navbar {
              ...
              <div class="card-content business">
                ...
                <!--           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label main-label" for="" contenteditable>Other Income</label>&nbsp;&nbsp;
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label main-label" for="" contenteditable>Other Income 2</label>&nbsp;&nbsp;
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label main-label" for="" contenteditable>Other Income 3</label>&nbsp;&nbsp;
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label main-label" for="" contenteditable>Other Income 4</label>&nbsp;&nbsp;
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label main-label" for="" contenteditable>Other Income 5</label>&nbsp;&nbsp;
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                <label class="label main-label" for="" contenteditable>Other Income 6</label>&nbsp;&nbsp;
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control two_self_other_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="two_selfb_oi_year1" value="0" placeholder="Other Income">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control three_self_other_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="three_selfb_oi_year1" value="0" placeholder="Other Income">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control four_self_other_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="four_selfb_oi_year1" value="0" placeholder="Other Income">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control five_self_other_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="five_selfb_oi_year1" value="0" placeholder="Other Income">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control six_self_other_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="six_selfb_oi_year1" value="0" placeholder="Other Income">
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control two_self_other_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="two_selfb_oi_year2" value="0" placeholder="Other Income">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control three_self_other_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="three_selfb_oi_year2" value="0" placeholder="Other Income">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control four_self_other_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="four_selfb_oi_year2" value="0" placeholder="Other Income">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control five_self_other_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="five_selfb_oi_year2" value="0" placeholder="Other Income">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control six_self_other_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="six_selfb_oi_year2" value="0" placeholder="Other Income">
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control two_self_other_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="two_selfb_oi_year3" value="0" placeholder="Other Income">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control three_self_other_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="three_selfb_oi_year3" value="0" placeholder="Other Income">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control four_self_other_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="four_selfb_oi_year3" value="0" placeholder="Other Income">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control five_self_other_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="five_selfb_oi_year3" value="0" placeholder="Other Income">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control six_self_other_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="six_selfb_oi_year3" value="0" placeholder="Other Income">
                               ...
                               <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control two_self_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="two_selfb_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                               ...
                               <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control three_self_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="three_selfb_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                               ...
                               <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control four_self_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="four_selfb_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                               ...
                               <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control five_self_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="five_selfb_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                               ...
                               <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control six_self_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="six_selfb_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control two_self_all_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="two_selfb_oi_avg_all" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control three_self_all_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="three_selfb_oi_avg_all" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
...
<div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control four_self_all_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="four_selfb_oi_avg_all" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
...
<div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control five_self_all_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="five_selfb_oi_avg_all" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
...
<div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control six_self_all_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="six_selfb_oi_avg_all" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control two_self1_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="two_selfb1_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control three_self1_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="three_selfb1_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control four_self1_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="four_selfb1_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control five_self1_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="five_selfb1_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control six_self1_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="six_selfb1_oi_avg_latest" value="0" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="incomeModalLabel">Add Other Income</h5>
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="col-md-3" style="text-align: center;"><label>Name</label> </div>
            <div class="col-md-2 mr-1" style="text-align: center;"><label>Year 1</label></div>
            <div class="col-md-2 mr-1" style="text-align: center;"><label>Year 2</label></div>
            <div class="col-md-2 mr-1" style="text-align: center;"><label>Year 3</label></div>
          </div>
          <div class="row mb-1">
            <div class="col-md-1"><a id="add_multiple_oi"><i class="fa fa-plus"></i></a></div>
            <div class="col-md-3"><textarea class="form-control income_name1" type="text" name="income_name1" rows="1" id="income_name1"></textarea></div>
            <div class="col-md-2 mr-1"><input class="form-control income_year1b" type="text" name="income_year1b" value="0" id="income_year1b"></div>
            <div class="col-md-2 mr-1"><input class="form-control income_year2b" type="text" name="income_year2b" value="0" id="income_year2b"></div>
            <div class="col-md-2 mr-1"><input class="form-control income_year3b" type="text" name="income_year3b" value="0" id="income_year3b"></div>
          </div>
          <div id="modalmultiple_field"></div>
        </div>
        <button type="button" class="btn btn-secondary mt-1" id="close" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary mt-1" id="otherAdd">Add</button>
      </div>
...
function updateInvoice() {
  ...
  for (var a = document.querySelectorAll('table.inventory tbody tr'), i = 0; a[i]; ++i) {
    ...
    percentage_cell=parseFloatHTML(cells[8])/100;
    if(cells[9]!=0 && cells[9]!="undefined" && cells[9]!=null && cells[9]!="null"){
        
        gst_cell=parseFloatHTML(cells[9])/100;
    }else{
        gst_cell=0;
    }
    
    
    calculation_one=parseFloar(percentage_cell)*parseFloatHTML(cells[5]);
    calculation_two=parseFloar(percentage_cell)*parseFloatHTML(cells[5]);
