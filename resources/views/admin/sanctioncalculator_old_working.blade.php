...
var co_self_total_deduction_year_three_average=parseFloat(co_self_latest_monthly_average_tax)+parseFloat(co_self_latest_monthly_average_ded);
  ...
  parseFloat(eligilble_other_income)+parseFloat(six_salary_gross_income)+parseFloat(co_six_salary_gross_income);
    ...
    console.log("total:" +self_total_year_three_average);
  console.log("cototal:" +co_self_total_year_three_average);
    console.log("rental:" +eligilble_rental_income);
        console.log("other:" +eligilble_other_income);
            console.log("gross:" +six_salary_gross_income);
                console.log("cogross:" +co_six_salary_gross_income);
