      ...
      <section class="simple-validation">
                      ...
                      <div class="col-lg-2 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control master_income_margin" required="" data-validation-required-message="This field is required" type="text" name="master_income_margin" value="{{$sanction->master_income_margin}}" placeholder="Income Margin">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control master_rental_margin" required="" data-validation-required-message="This field is required" type="text" name="master_rental_margin" value="{{$sanction->master_rental_margin}}" placeholder="Rental Margin">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control master_ltv_margin_one" required="" data-validation-required-message="This field is required" type="text" name="master_ltv_margin" value="{{$sanction->master_ltv_margin}}" placeholder="LTV Margin">
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control master_ltv_margin_two" required="" data-validation-required-message="This field is required" type="text" name="master_ltv_margin2" value="{{$sanction->master_ltv_margin2}}" placeholder="LTV Margin">
                                @if ($errors->has('master_ltv_margin'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('master_ltv_margin') }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control master_ltv_margin_three" required="" data-validation-required-message="This field is required" type="text" name="master_ltv_margin3" value="{{$sanction->master_ltv_margin3}}" placeholder="LTV Margin">
                                @if ($errors->has('master_ltv_margin'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('master_ltv_margin') }}</strong>
                                </span>
        ...
        <div class="col-md-12 business" style="padding-top: 20px;padding-bottom: 20px;">
               ...
               <div class="col-md-12 working hidden" style="padding-top: 20px;padding-bottom: 20px;">
                <span><b>Month 1 </b><input type="checkbox" class="month_one_check" name="month_one" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Month 2</b> <input type="checkbox" class="month_two_check" name="month_two" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Month 3</b> <input type="checkbox" class="month_three_check" name="month_three" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Month 4</b> <input type="checkbox" class="month_four_check" name="month_four" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Month 5</b> <input type="checkbox" class="month_five_check" name="month_five" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Latest Month</b> <input type="checkbox" class="month_six_check" name="month_six" checked=""></span>
                    ...
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <textarea class="form-control" required="" value="{{$sanction->name}}" rows="1" data-validation-required-message="This field is required" type="text" name="name" value="0" placeholder="Name">{{$sanction->name}}</textarea>
                        @if ($errors->has('name'))
                        <span class="help-block">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 {{ $errors->has('bank_name') ? ' has-error' : '' }}" style="padding-left: 20px !important;">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <input class="form-control date_of_birth" required="" value="{{$sanction->dob}}" data-validation-required-message="This field is required" type="date" name="dob" value="" placeholder="Date of Birth">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 {{ $errors->has('age') ? ' has-error' : '' }}" style="padding-left: 20px !important;">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <input class="form-control age" required="" value="{{$sanction->age}}" data-validation-required-message="This field is required" type="text" name="age" value="0" placeholder="Age">
                          @if ($errors->has('age'))
                          <span class="help-block">
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_gross_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_gi_year1" value="{{$sanction->selfb_gi_year1}}" placeholder="Gross Income">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_salary_ren_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_sr_year1" value="{{$sanction->selfb_sr_year1}}" placeholder="Salary/Remuneration">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_interest_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_interest_year1" value="{{$sanction->selfb_interest_year1}}" placeholder="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_agriculture_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_ai_year1" value="{{$sanction->selfb_ai_year1}}" placeholder="Agriculture Income">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_other_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_oi_year1" value="{{$sanction->selfb_oi_year1}}" placeholder="Other Income">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_depreciation_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_d_year1" value="{{$sanction->selfb_d_year1}}" placeholder="Depreciation">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_total_gross_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_tgi_year1" value="{{$sanction->selfb_tgi_year1}}" placeholder="Total Gross Income" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_tax_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_tax_year1" value="{{$sanction->selfb_tax_year1}}" placeholder="Depreciation">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_other_ded_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_od_year1" value="{{$sanction->selfb_od_year1}}" placeholder="Depreciation">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_total_deduction_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfb_td_year1" value="{{$sanction->selfb_td_year1}}" placeholder="Total Deduction" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                   ...
                   <div class="col-md-12" style="display: inline-flex;padding: 0px;" >
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_gross_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_gi_year2" value="{{$sanction->selfb_gi_year2}}" placeholder="Gross Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_salary_ren_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_sr_year2" value="{{$sanction->selfb_sr_year2}}" placeholder="Salary/Remuneration">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_interest_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_interest_year2" value="{{$sanction->selfb_interest_year2}}" placeholder="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_agriculture_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_ai_year2" value="{{$sanction->selfb_ai_year2}}" placeholder="Agriculture Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_other_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_oi_year2" value="{{$sanction->selfb_oi_year2}}" placeholder="Other Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_depreciation_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_d_year2" value="{{$sanction->selfb_d_year2}}" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_gross_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_tgi_year2" value="{{$sanction->selfb_tgi_year2}}" placeholder="Total Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_tax_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_tax_year2" value="{{$sanction->selfb_tax_year2}}" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_other_ded_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_od_year2" value="{{$sanction->selfb_od_year2}}" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_deduction_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfb_td_year2" value="{{$sanction->selfb_td_year2}}" placeholder="Total Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_gross_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_gi_yearlatest" value="{{$sanction->selfb_gi_yearlatest}}" placeholder="Gross Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_salary_ren_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_sr_yearlatest" value="{{$sanction->selfb_sr_yearlatest}}" placeholder="Salary/Remuneration">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_interest_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_interest_yearlatest" value="{{$sanction->selfb_interest_yearlatest}}" placeholder="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_agriculture_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_ai_yearlatest" value="{{$sanction->selfb_ai_yearlatest}}" placeholder="Agriculture Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_other_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_oi_yearlatest" value="{{$sanction->selfb_oi_yearlatest}}" placeholder="Other Income">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_depreciation_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_d_yearlatest" value="{{$sanction->selfb_d_yearlatest}}" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_gross_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_tgi_yearlatest" value="{{$sanction->selfb_tgi_yearlatest}}" placeholder="Total Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_tax_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_tax_yearlatest" value="{{$sanction->selfb_tax_yearlatest}}" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_other_ded_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_od_yearlatest" value="{{$sanction->selfb_od_yearlatest}}" placeholder="Depreciation">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_deduction_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfb_td_yearlatest" value="{{$sanction->selfb_td_yearlatest}}" placeholder="Total Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfb_gi_avg_latest" value="{{$sanction->selfb_gi_avg_latest}}" placeholder="Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_salary_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfb_sr_avg_latest" value="{{$sanction->selfb_sr_avg_latest}}" placeholder="Salary/Remuneration" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_interest_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfb_interest_avg_latest" value="{{$sanction->selfb_interest_avg_latest}}" placeholder="" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_agriculture" required="" data-validation-required-message="This field is required" type="text" name="selfb_ai_avg_latest" value="{{$sanction->selfb_ai_avg_latest}}" placeholder="Agriculture Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="selfb_oi_avg_latest" value="{{$sanction->selfb_oi_avg_latest}}" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_depreciation" required="" data-validation-required-message="This field is required" type="text" name="selfb_d_avg_latest" value="{{$sanction->selfb_d_avg_latest}}" placeholder="Depreciation" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="selfb_tgi_avg_latest" value="{{$sanction->selfb_tgi_avg_latest}}" placeholder="Total Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_tax" required="" data-validation-required-message="This field is required" type="text" name="selfb_tax_avg_latest" value="{{$sanction->selfb_tax_avg_latest}}" placeholder="Tax" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_latest_monthly_average_ded" required="" data-validation-required-message="This field is required" type="text" name="selfb_od_avg_latest" value="{{$sanction->selfb_od_avg_latest}}" placeholder="Other Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_deduction_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="selfb_td_avg_latest" value="{{$sanction->selfb_td_avg_latest}}" placeholder="Total Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                           ...
                           <!--    <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}" style="visibility: hidden;">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfb_gi_avg_all" value="{{$sanction->selfb_gi_avg_all}}" placeholder="Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_salary_ren_avg_all" required="" data-validation-required-message="This field is required" type="text" name="selfb_sr_avg_all" value="{{$sanction->selfb_sr_avg_all}}" placeholder="Salary/Remuneration" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control self_interest_avg_all" required="" data-validation-required-message="This field is required" type="text" name="selfb_interest_avg_all" value="{{$sanction->selfb_interest_avg_all}}" placeholder="" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_agriculture" required="" data-validation-required-message="This field is required" type="text" name="selfb_ai_avg_all" value="{{$sanction->selfb_ai_avg_all}}" placeholder="Agriculture Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="selfb_oi_avg_all" value="{{$sanction->selfb_oi_avg_all}}" placeholder="Other Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_depreciation" required="" data-validation-required-message="This field is required" type="text" name="selfb_d_avg_all" value="{{$sanction->selfb_d_avg_all}}" placeholder="Depreciation" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="selfb_tgi_avg_all" value="{{$sanction->selfb_tgi_avg_all}}" placeholder="Total Gross Income" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_tax" required="" data-validation-required-message="This field is required" type="text" name="selfb_tax_avg_all" value="{{$sanction->selfb_tax_avg_all}}" placeholder="Tax" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_all_monthly_average_ded" required="" data-validation-required-message="This field is required" type="text" name="selfb_od_avg_all" value="{{$sanction->selfb_od_avg_all}}" placeholder="Other Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                <div class="form-group">
                                  <div class="controls">
                                    ...
                                    <input class="form-control self_total_deduction_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="selfb_td_avg_all" value="{{$sanction->selfb_td_avg_all}}" placeholder="Total Deduction" readonly="">
                                    @if ($errors->has('bank_name'))
                                    <span class="help-block">
                                      <strong>{{ $errors->first('bank_name') }}</strong>
                                    </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_gross_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_gi_year1" value="{{$sanction->selfco_gi_year1}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_salary_ren_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_sr_year1" value="{{$sanction->selfco_sr_year1}}" placeholder="Salary/Remuneration">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_interest_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_interest_year1" value="{{$sanction->selfco_interest_year1}}" placeholder="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_agriculture_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_ai_year1" value="{{$sanction->selfco_ai_year1}}" placeholder="Agriculture Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_income_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_oi_year1" value="{{$sanction->selfco_oi_year1}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_depreciation_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_d_year1" value="{{$sanction->selfco_d_year1}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_gross_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_tgi_year1" value="{{$sanction->selfco_tgi_year1}}" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_tax_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_tax_year1" value="{{$sanction->selfco_tax_year1}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_ded_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_od_year1" value="{{$sanction->selfco_od_year1}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_one" required="" data-validation-required-message="This field is required" type="text" name="selfco_td_year1" value="{{$sanction->selfco_td_year1}}" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_gross_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_gi_year2" value="{{$sanction->selfco_gi_year2}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                    @endif</div>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_salary_ren_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_sr_year2" value="{{$sanction->selfco_sr_year2}}" placeholder="Salary/Remuneration">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_interest_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_interest_year2" value="{{$sanction->selfco_interest_year2}}" placeholder="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_agriculture_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_ai_year2" value="{{$sanction->selfco_ai_year2}}" placeholder="Agriculture Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_income_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_oi_year2" value="{{$sanction->selfco_oi_year2}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_depreciation_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_d_year2" value="{{$sanction->selfco_d_year2}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_gross_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_tgi_year2" value="{{$sanction->selfco_tgi_year2}}" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_tax_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_tax_year2" value="{{$sanction->selfco_tax_year2}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_ded_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_od_year2" value="{{$sanction->selfco_od_year2}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_two" required="" data-validation-required-message="This field is required" type="text" name="selfco_td_year2" value="{{$sanction->selfco_td_year2}}" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_gross_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_gi_yearlatest" value="{{$sanction->selfco_gi_yearlatest}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                    @endif</div>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_salary_ren_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_sr_yearlatest" value="{{$sanction->selfco_sr_yearlatest}}" placeholder="Salary/Remuneration">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_interest_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_interest_yearlatest" value="{{$sanction->selfco_interest_yearlatest}}" placeholder="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_agriculture_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_ai_yearlatest" value="{{$sanction->selfco_ai_yearlatest}}" placeholder="Agriculture Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_income_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_oi_yearlatest" value="{{$sanction->selfco_oi_yearlatest}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_depreciation_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_d_yearlatest" value="{{$sanction->selfco_d_yearlatest}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_gross_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_tgi_yearlatest" value="{{$sanction->selfco_tgi_yearlatest}}" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_tax_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_tax_yearlatest" value="{{$sanction->selfco_tax_yearlatest}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_other_ded_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_od_yearlatest" value="{{$sanction->selfco_od_yearlatest}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_three" required="" data-validation-required-message="This field is required" type="text" name="selfco_td_yearlatest" value="{{$sanction->selfco_td_yearlatest}}" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfco_gi_avg_latest" value="{{$sanction->selfco_gi_avg_latest}}" placeholder="Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_salary_ren_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfco_sr_avg_latest" value="{{$sanction->selfco_sr_avg_latest}}" placeholder="Salary/Remuneration" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_interest_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfco_interest_avg_latest" value="{{$sanction->selfco_interest_avg_latest}}" placeholder="" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_agriculture" required="" data-validation-required-message="This field is required" type="text" name="selfco_ai_avg_latest" value="{{$sanction->selfco_ai_avg_latest}}" placeholder="Agriculture Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="selfco_oi_avg_latest" value="{{$sanction->selfco_oi_avg_latest}}" placeholder="Other Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_depreciation" required="" data-validation-required-message="This field is required" type="text" name="selfco_d_avg_latest" value="{{$sanction->selfco_d_avg_latest}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="selfco_tgi_avg_latest" value="{{$sanction->selfco_tgi_avg_latest}}" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_tax" required="" data-validation-required-message="This field is required" type="text" name="selfco_tax_avg_latest" value="{{$sanction->selfco_tax_avg_latest}}" placeholder="Tax" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_latest_monthly_average_ded" required="" data-validation-required-message="This field is required" type="text" name="selfco_od_avg_latest" value="{{$sanction->selfco_od_avg_latest}}" placeholder="Other Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_three_average" required="" data-validation-required-message="This field is required" type="text" name="selfco_td_avg_latest" value="{{$sanction->selfco_td_avg_latest}}" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfco_gi_avg_all" value="{{$sanction->selfco_gi_avg_all}}" placeholder="Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                    @endif</div>
                            ...
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_salary_ren_all_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfco_sr_avg_all" value="{{$sanction->selfco_sr_avg_all}}" placeholder="Salary/Remuneration" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                            <div class="form-group">
                              <div class="controls">
                                ...
                                <input class="form-control selfco_interest_all_monthly_average_gross" required="" data-validation-required-message="This field is required" type="text" name="selfco_interest_avg_all" value="{{$sanction->selfco_interest_avg_all}}" placeholder="" readonly="">
                                @if ($errors->has('bank_name'))
                                <span class="help-block">
                                  <strong>{{ $errors->first('bank_name') }}</strong>
                                </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_agriculture" required="" data-validation-required-message="This field is required" type="text" name="selfco_ai_avg_all" value="{{$sanction->selfco_ai_avg_all}}" placeholder="Agriculture Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_other_income" required="" data-validation-required-message="This field is required" type="text" name="selfco_oi_avg_all" value="{{$sanction->selfco_oi_avg_all}}" placeholder="Other Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_depreciation" required="" data-validation-required-message="This field is required" type="text" name="selfco_d_avg_all" value="{{$sanction->selfco_d_avg_all}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="selfco_tgi_year_all" value="{{$sanction->selfco_tgi_year_all}}" placeholder="Total Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_tax" required="" data-validation-required-message="This field is required" type="text" name="selfco_tax_avg_all" value="{{$sanction->selfco_tax_avg_all}}" placeholder="Tax" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_all_monthly_average_ded" required="" data-validation-required-message="This field is required" type="text" name="selfco_od_avg_all" value="{{$sanction->selfco_od_avg_all}}" placeholder="Other Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_self_total_deduction_year_all_average" required="" data-validation-required-message="This field is required" type="text" name="selfco_td_avg_all" value="{{$sanction->selfco_td_avg_all}}" placeholder="Total Deduction" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control one_salary_gross_income" id="demo" required="" data-validation-required-message="This field is required" type="text" name="salb_gi_month1" value="{{$sanction->salb_gi_month1}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control one_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salb_tax_month1" value="{{$sanction->salb_tax_month1}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control one_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salb_od_month1" value="{{$sanction->salb_od_month1}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control one_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salb_nmi_month1" value="{{$sanction->salb_nmi_month1}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control two_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salb_gi_month2" value="{{$sanction->salb_gi_month2}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control two_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salb_tax_month2" value="{{$sanction->salb_tax_month2}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control two_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salb_od_month2" value="{{$sanction->salb_od_month2}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control two_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salb_nmi_month2" value="{{$sanction->salb_nmi_month2}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control three_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salb_gi_month3" value="{{$sanction->salb_gi_month3}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control three_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salb_tax_month3" value="{{$sanction->salb_tax_month3}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control three_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salb_od_month3" value="{{$sanction->salb_od_month3}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control three_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salb_nmi_month3" value="{{$sanction->salb_nmi_month3}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control four_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salb_gi_month4" value="{{$sanction->salb_gi_month4}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control four_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salb_tax_month4" value="{{$sanction->salb_tax_month4}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control four_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salb_od_month4" value="{{$sanction->salb_od_month4}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control four_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salb_nmi_month4" value="{{$sanction->salb_nmi_month4}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control five_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salb_gi_month5" value="{{$sanction->salb_gi_month5}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control five_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salb_tax_month5" value="{{$sanction->salb_tax_month5}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control five_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salb_od_month5" value="{{$sanction->salb_od_month5}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control five_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salb_nmi_month5" value="{{$sanction->salb_nmi_month5}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control six_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salb_gi_monthlatest" value="{{$sanction->salb_gi_monthlatest}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control six_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salb_tax_monthlatest" value="{{$sanction->salb_tax_monthlatest}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control six_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salb_od_monthlatest" value="{{$sanction->salb_od_monthlatest}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control six_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salb_nmi_monthlatest" value="{{$sanction->salb_nmi_monthlatest}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control average_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salb_gi_avg" value="{{$sanction->salb_gi_avg}}" placeholder="Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control average_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salb_tax_avg" value="{{$sanction->salb_tax_avg}}" placeholder="Other Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control average_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salb_od_avg" value="{{$sanction->salb_od_avg}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control average_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salb_nmi_avg" value="{{$sanction->salb_nmi_avg}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
          ...
          <div class="card-header existing_loan_co_check hidden">
            <h6 class="card-title">Co-Borrower</h6>
               ...
               <div class="col-md-12  existing_loan_co_check hidden" style="padding-top: 20px;padding-bottom: 20px;">
                <span><b>Month 1 </b><input type="checkbox" class="co_month_one_check" name="comonth_one" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Month 2</b> <input type="checkbox" class="co_month_two_check" name="comonth_two" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Month 3</b> <input type="checkbox" class="co_month_three_check" name="comonth_three" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Month 4</b> <input type="checkbox" class="co_month_four_check" name="comonth_four" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Month 5</b> <input type="checkbox" class="co_month_five_check" name="comonth_five" checked=""></span>&nbsp;&nbsp;
                 <span> <b>Latest Month</b> <input type="checkbox" class="co_month_six_check" name="comonth_six" checked=""></span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_one_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salco_gi_month1" value="{{$sanction->salco_gi_month1}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_one_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salco_tax_month1" value="{{$sanction->salco_tax_month1}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_one_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salco_od_month1" value="{{$sanction->salco_od_month1}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_one_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salco_nmi_month1" value="{{$sanction->salco_nmi_month1}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_two_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salco_gi_month2" value="{{$sanction->salco_gi_month2}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_two_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salco_tax_month2" value="{{$sanction->salco_tax_month2}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_two_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salco_od_month2" value="{{$sanction->salco_od_month2}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_two_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salco_nmi_month2" value="{{$sanction->salco_nmi_month2}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_three_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salco_gi_month3" value="{{$sanction->salco_gi_month3}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_three_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salco_tax_month3" value="{{$sanction->salco_tax_month3}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_three_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salco_od_month3" value="{{$sanction->salco_od_month3}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_three_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salco_nmi_month3" value="{{$sanction->salco_nmi_month3}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_four_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salco_gi_month4" value="{{$sanction->salco_gi_month4}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_four_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salco_tax_month4" value="{{$sanction->salco_tax_month4}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_four_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salco_od_month4" value="{{$sanction->salco_od_month4}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_four_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salco_nmi_month4" value="{{$sanction->salco_nmi_month4}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_five_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salco_gi_month5" value="{{$sanction->salco_gi_month5}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_five_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salco_tax_month5" value="{{$sanction->salco_tax_month5}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_five_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salco_od_month5" value="{{$sanction->salco_od_month5}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_five_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salco_nmi_month5" value="{{$sanction->salco_nmi_month5}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_six_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salco_gi_monthlatest" value="{{$sanction->salco_gi_monthlatest}}" placeholder="Gross Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_six_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salco_tax_monthlatest" value="{{$sanction->salco_tax_monthlatest}}" placeholder="Other Income">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_six_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salco_od_monthlatest" value="{{$sanction->salco_od_monthlatest}}" placeholder="Depreciation">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_six_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salco_nmi_monthlatest" value="{{$sanction->salco_nmi_monthlatest}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_average_salary_gross_income" required="" data-validation-required-message="This field is required" type="text" name="salco_gi_avg" value="{{$sanction->salco_gi_avg}}" placeholder="Gross Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_average_salary_tax" required="" data-validation-required-message="This field is required" type="text" name="salco_tax_avg" value="{{$sanction->salco_tax_avg}}" placeholder="Other Income" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_average_salary_deduction" required="" data-validation-required-message="This field is required" type="text" name="salco_od_avg" value="{{$sanction->salco_od_avg}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control co_average_net_montly_income" required="" data-validation-required-message="This field is required" type="text" name="salco_nmi_avg" value="{{$sanction->salco_nmi_avg}}" placeholder="Depreciation" readonly="">
                      @if ($errors->has('bank_name'))
                      <span class="help-block">
                        <strong>{{ $errors->first('bank_name') }}</strong>
                      </span>
  ...
  <div class="row" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required future_rent" id="future_rent" value="{{$sanction->rent}}" name="rent">
     </div>
   ...
   <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required eligilble_rental_income" value="{{$sanction->eligible_rental_income}}" id="eligilble_rental_income" name="eligible_rental_income" readonly="">
    </div>
  ...
  <div class="row" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required other_monthy" value="{{$sanction->other_monthly}}" id="other_monthy" name="other_monthly">
     </div>
   ...
   <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required eligilble_other_income" value="{{$sanction->eligible_other_income}}" id="eligilble_rental_income" name="eligible_other_income" readonly="">
    </div>
...
<div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 30px;padding-top: 20px;">
  ...
  <div class="col-md-12" > 
    ...
    <div class="col-sm-4">
     ...
     <div class="col-md-12" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control total_monthly_gross_income" id="total_monthly_gross_income" value="{{$sanction->disposal_gi_latest_itr}}" name="disposal_gi_latest_itr" readonly="">
     </div>
   ...
   <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required new_deduction" id="new_deduction" value="{{$sanction->disposal_d_latest_itr}}" name="disposal_d_latest_itr" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required net_income_after_tax" value="{{$sanction->disposal_niat_latest_itr}}" id="net_income_after_tax" name="disposal_niat_latest_itr" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required other_emi" value="{{$sanction->disposal_otheremi_latest_itr}}" id="other_emi" name="disposal_otheremi_latest_itr" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required net_income_deduction" value="{{$sanction->disposal_niad_latest_itr}}" id="net_income_deduction" name="disposal_niad_latest_itr" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required 40_gross_income" value="{{$sanction->disposal_grossi_latest_itr}}" id="40_gross_income" name="disposal_grossi_latest_itr" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required total_disposal_income" value="{{$sanction->disposable_income_latest_itr}}" id="total_disposal_income time_period" name="disposable_income_latest_itr" readonly="">
    </div>
...
<div class="col-sm-4">
  ...
  <div class="col-md-12 average_itr_hidden" > 
    <div class="form-group">
     ...
     <input type="text" class="form-control total_monthly_gross_income_two" id="total_monthly_gross_income" value="{{$sanction->disposal_gi_avg_itr}}" name="disposal_gi_avg_itr" readonly="">
   </div>
 ...
 <div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required new_deduction_two" id="deduction" value="{{$sanction->disposal_d_avg_itr}}" name="disposal_d_avg_itr" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required net_income_after_tax_two" value="{{$sanction->disposal_niat_avg_itr}}" id="net_income_after_tax" name="disposal_niat_avg_itr" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required other_emi_two" value="{{$sanction->disposal_otheremi_avg_itr}}" id="other_emi" name="disposal_otheremi_avg_itr" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required net_income_deduction_two" value="{{$sanction->disposal_niad_avg_itr}}" id="net_income_deduction" name="disposal_niad_avg_itr" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required 40_gross_income_two" value="{{$sanction->disposal_grossi_avg_itr}}" id="40_gross_income" name="disposal_grossi_avg_itr" readonly="">
  </div>
...
<div class="col-md-12 average_itr_hidden" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required total_disposal_income_two" value="{{$sanction->disposable_income_avg_itr}}" id="total_disposal_income time_period" name="disposable_income_avg_itr" readonly="">
  </div>
 ...
 <div class="col-lg-12 col-md-12 col-sm-6">
  <h5 class="move-right">Reverse EMI Calculator </h5>
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control reverse_loan_amount_rs" id="loan_amount_rs" value="{{$sanction->reverse_loan_amt}}" name="reverse_loan_amt" readonly="">
     </div>
   ...
   <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required reverse_interest" id="interest" value="{{$sanction->reverse_interest}}" name="reverse_interest">
    </div>
  ...
  <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required reverse_time_period" value="{{$sanction->reverse_time_period}}" id="number_of_month time_period" name="reverse_time_period">
    </div>
  ...
  <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required reverse_emi_amount" value="{{$sanction->reverse_emi}}" id="total_disposal_income_two" name="reverse_emi" readonly="">
    </div>
...
<div class="col-lg-12">
 ...
 <div class="col-md-12" > 
      ...
      <div class="col-md-12" > 
        <div class="form-group">
         ...
         <input type="text" class="form-control required quantam_applicant" value="{{$sanction->quantam_applicant}}" id="quantam_applicant" name="quantam_applicant" readonly="">
       </div>
     ...
     <div class="col-md-12" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required quantam_applicant_one" value="{{$sanction->quantam_coapplicant1}}" id="quantam_applicant_one" name="quantam_coapplicant1" readonly="">
     </div>
   ...
   <div class="col-md-12" > 
    <div class="form-group">
     ...
     <input type="text" class="form-control required quantam_applicant_two" value="{{$sanction->quantam_applicant_two}}" id="quantam_applicant_two" name="quantam_coapplicant2" readonly="">
   </div>
 ...
 <div class="col-md-12" > 
  <div class="form-group">
   ...
   <input type="text" class="form-control required quantam_applicant_three" value="{{$sanction->quantam_coapplicant3}}" id="quantam_applicant_three" name="quantam_coapplicant3" readonly="">
 </div>
...
<div class="col-md-12" > 
  <div class="form-group">
   ...
   <input type="text" class="form-control required max_quantom_loan_home" value="{{$sanction->max_quantam_homeloan}}" id="max_quantom_loan_home" name="max_quantam_homeloan" readonly="">
 </div>
 ...
 <div class="col-md-12" > 
    ...
    <div class="col-md-12" > 
      <div class="form-group">
        ...
        <input type="text" class="form-control required maximum_age_month" value="{{$sanction->max_age_months}}" id="maximum_age_month" name="max_age_months" readonly="">
      </div>
    ...
    <div class="col-md-12" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required remaining_age" value="{{$sanction->remaining_age}}" id="remaining_age" name="remaining_age" readonly="">
     </div>
   ...
   <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required max_eligibile_term_month" value="{{$sanction->max_eligible_term}}" id="max_eligibile_term_month" name="max_eligible_term" readonly="">
    </div>
  ...
  <div class="col-md-12" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required max_eligibile_term_relax" value="{{$sanction->max_eligible_term_relex}}" id="max_eligibile_term_relax" name="max_eligible_term_relex" readonly="">
    </div>
...
<div class="col-lg-12 col-md-12 col-sm-6">
  ...
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required interest_rate" value="{{$sanction->repayment_capacity_interest_rate}}" id="interest_rate" name="repayment_capacity_interest_rate">
     </div>
   ...
   <div class="col-md-6" > 
    <div class="form-group">
     ...
     <input type="text" class="form-control required number_of_month" value="{{$sanction->no_of_months}}" id="number_of_month" name="no_of_months">
   </div>
 ...
 <div class="col-md-6" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required emi_per_lakh" value="{{$sanction->emi_per_lakhs}}" id="emi_per_lakh" name="emi_per_lakhs" readonly="">
  </div>
...
<div class="col-md-6" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required eligilble_as_per_average_income" value="{{$sanction->eligible_avg_income}}" id="eligilble_as_per_average_income" name="eligible_avg_income" readonly="">
  </div>
...
<div class="col-md-6" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required eligilble_as_per_latest" value="{{$sanction->eligible_latest_income}}" id="number_of_month" name="eligible_latest_income" readonly="">
  </div>
...
<div class="col-lg-12 col-md-12 col-sm-6">
 ...
 <div class="row move-right" >
  ...
  <div class="col-md-6" > 
    <div class="form-group">
     ...
     <input type="text" class="form-control required ltv_mkt_property" value="{{$sanction->ltv_mkt_property_val}}" id="ltv_mkt_property" name="ltv_mkt_property_val">
   </div>
 ...
 <div class="col-md-6" > 
  <div class="form-group">
   ...
   <input type="text" class="form-control required ltv_cost_of_project" id="ltv_cost_of_project" value="{{$sanction->cost_of_project}}" name="cost_of_project">
 </div>
...
<div class="col-md-6" > 
  <div class="form-group">
   ...
   <input type="text" class="form-control required ltv_loan_amount_applied" value="{{$sanction->ltv_loan_amount}}" id="ltv_loan_amount_applied" name="ltv_loan_amount">
 </div>
...
<div class="col-md-6" > 
  <div class="form-group">
    ...
    <input type="text" class="form-control required value_to_be_consider" value="{{$sanction->ltv_value_consider}}" id="value_to_be_consider" name="ltv_value_consider" readonly="">
  </div>
...
<div class="col-md-6" > 
  <div class="form-group">
   ...
   <input type="text" class="form-control required ltv_takeover" id="ltv_takeover" value="{{$sanction->ltv_takeover}}" name="ltv_takeover">
 </div>
  ...
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
        ...
        <input type="text" class="form-control required value_to_be_consider_two" value="{{$sanction->eligible_ltv}}" id="property_value" name="eligible_ltv" readonly="">
      </div>
    ...
    <div class="col-md-6" > 
      <div class="form-group">
        ...
        <input type="text" class="form-control required ltv_takeover_two" value="{{$sanction->eligible_ltv_takeover}}" id="balance_home_loan_account" name="eligible_ltv_takeover" readonly="">
      </div>
  ...
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
        ...
        <input type="text" class="form-control required maximum_eligible_loan_average" value="{{$sanction->eligible_max_home_loan_amt_avg}}" id="maximum_eligible_loan_average" name="eligible_max_home_loan_amt_avg" readonly="">
      </div>
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control required maximum_eligible_loan_year_month" value="{{$sanction->eligible_max_home_loan_amt_latest}}" id="maximum_eligible_loan_year_month" name="eligible_max_home_loan_amt_latest" readonly="">
     </div>
...
<div class="col-lg-12 col-md-12 col-sm-6">
  ...
  <div class="row move-right" >
    ...
    <div class="col-md-6" > 
      <div class="form-group">
       ...
       <input type="text" class="form-control loan_amount_rs" id="loan_amount_rs" value="{{$sanction->calc_loan_amt}}" name="calc_loan_amt">
     </div>
   ...
   <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required interest" id="interest" value="{{$sanction->calc_interest_rate}}" name="calc_interest_rate">
    </div>
  ...
  <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required time_period" value="{{$sanction->calc_time_period}}" id="number_of_month time_period" name="calc_time_period">
    </div>
  ...
  <div class="col-md-6" > 
    <div class="form-group">
      ...
      <input type="text" class="form-control required final_emi" value="{{$sanction->calc_emi}}" id="final_emi time_period" name="calc_emi" readonly="">
    </div>
...
<script type="text/javascript">
  ...
  radioButton.checked = false;
   ...
   var radioButtonnew = document.getElementById("salariedTab");
  radioButtonnew.checked = true;
  }else{
  var radioButton = document.getElementById("salariedTab");
  radioButton.checked = false;
