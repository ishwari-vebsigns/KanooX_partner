                 ...
                 <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('property_price') ? ' has-error' : '' }}">
                  ...
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control" required="" data-validation-required-message="This field is required" type="text" name="contact_number" value="{{ old('contact_number') }}" placeholder="Contact Number" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" onkeypress="return isNumberKey(event)">
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('email') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control" required="" data-validation-required-message="This field is required" type="email" name="email" value="{{ old('email') }}" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please Provide Valid Email Address">
                      @if ($errors->has('email'))
                      <span class="help-block">
