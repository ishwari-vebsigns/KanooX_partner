        ...
        <div class="col-md-12">
          ...
          <form class="form-horizontal" role="form" method="POST" action="{{config('app.baseURL')}}/admin/property/{{$property->property_id}}" enctype="multipart/form-data">
            ...
            <div class="contact-form">
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('property_pdf') ? ' has-error' : '' }}">
                    <div class="form-group">
                    <div class="controls">

                     <label style="font-size: 1rem">Property Details PDF</label>
                     <input type="file" class="form-control"data-validation-required-message="This field is required" name="property_pdf" accept="application/pdf" onchange="document.getElementById('property_pdf').src = window.URL.createObjectURL(this.files[0])" style="padding-top: 10px;"  value="{{config('app.baseURL')}}/storage/app/{{$property->property_pdf}}">
                     @if ($errors->has('property_pdf'))
                     <span class="help-block">
                      <strong>{{ $errors->first('property_pdf') }}</strong>
                    </span>
                    @endif
                    </div>
                    </div>
                 ...
                 <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('email') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control" required="" data-validation-required-message="This field is required" type="text" name="email" value="{{$property->email}}{{ old('email') }}" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please Provide Valid Email Address">
                      @if ($errors->has('email'))
                      <span class="help-block">
                ...
                <div class="editamenity col-lg-12 col-md-12 col-sm-6 {{ $errors->has('amenities_name') ? ' has-error' : '' }}">
                  <div class="form-group">
                    ...
                    <a href="{{config('app.baseURL')}}/admin/property/remove_amenity/{{$amenities->amenities_id}}"><span class="close">&times;</span></a>
                    <input class="form-control" required="" data-validation-required-message="This field is required" type="text" name="amenities_name[]" value="{{$amenities->amenities_name}}" placeholder="Amenities" style="width: 284px">
