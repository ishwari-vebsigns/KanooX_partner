                 ...
                 <div class="col-lg-12 col-md-12 col-sm-6 {{ $errors->has('propert_size') ? ' has-error' : '' }}">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input class="form-control" required="" data-validation-required-message="This field is required" type="text" name="propert_size" value="{{ old('propert_size') }}" placeholder="1, 2, 2.5 BHK">
