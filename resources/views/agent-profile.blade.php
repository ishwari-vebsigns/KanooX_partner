                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 {{ $errors->has('pincode') ? ' has-error' : '' }}">
                                                        <input type="text" class="form-control" id="val-range" name="pincode" value="{{old('$user->pincode',$user->pincode)}}" placeholder="Your 6 digit Pincode" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    @if(Auth::user()->kyc_status==0 || Auth::user()->kyc_status==1)
                                                        <div class="col-md-12 p-0 product-div">
                                                          <img class="img-fluid" src="{{$base_url}}/storage\app/{{$user->aadhar_front}}" id="current_product_image" style=" margin:auto;max-height:200px;max-width:200px;" onerror="this.src='{{$base_url}}/web-assets\images\resources/resume-1.jpg';">
                                                        </div>
                                                    @endif
                                            ...
                                            <div class="col-xl-6">
                                              ...
                                              <div class="form-group row">
                                                    ...
                                                    @if(Auth::user()->kyc_status==0 || Auth::user()->kyc_status==1)
                                                        <div class="col-md-12 p-0 product-div">
                                                          <img class="img-fluid" src="{{$base_url}}/storage\app/{{$user->aadhar_back}}" id="current_product_image" style=" margin:auto;max-height:200px;max-width:200px;" onerror="this.src='{{$base_url}}/web-assets\images\resources/resume-1.jpg';">
                                                        </div>
                                                    @endif
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    @if(Auth::user()->kyc_status==0 || Auth::user()->kyc_status==1)
                                                        <div class="col-md-12 p-0 product-div">
                                                          <img class="img-fluid" src="{{$base_url}}/storage\app/{{$user->pan_card}}" id="current_product_image" style=" margin:auto;max-height:200px;max-width:200px;" onerror="this.src='{{$base_url}}/web-assets\images\resources/resume-1.jpg';">
                                                        </div>
                                                    @endif
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-range">Upload KYC video
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6 {{ $errors->has('pan_card') ? ' has-error' : '' }}">
