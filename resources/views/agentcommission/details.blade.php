...
<div class="content-body">
            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{$base_url}}/admin/agent-commission/all">Commissions</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Commission</a></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body"> 
                                ...
                                <form class="" action="{{$check_commission->agent_commission_id}}" method="post" enctype='multipart/form-data'>
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-10">
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-skill">Select Role
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-number">Commission Percentage<span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6 {{ $errors->has('commission') ? ' has-error' : '' }}">
                                                        <input type="text" value="{{old('commission)', $check_commission->commission)}}" class="form-control" id="" name="commission" placeholder="Add Commission in Percentage...">
...
<script class="">
    ...
    $("#role_id option[value={{$check_commission->role_id}}]").prop('selected',true);
