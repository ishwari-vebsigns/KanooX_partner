                                        ...
                                        <div class="row">
                                            <div class="col-xl-10">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="form-control" id="main_service_id" name="sub_service_id" >
                                                            <option value="">Please select</option>
                                                            @foreach($services as $service)
                                                            <option value="{{$service->service_id}}">{{$service->service_name}}</option>
                                                            @endforeach
                                                        </select>
                                                         @if ($errors->has('sub_service_id'))
                                                        <span class="help-block">
                                                        <strong>{{ $errors->first('sub_service_id') }}</strong>
                                                        </span> 
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 {{ $errors->has('commission') ? ' has-error' : '' }}">
                                                        <input type="text" class="form-control" id="" name="commission" placeholder="Add Commission e.g. 12">
...
<script class="">
    ...
    $.ajax({
               ...
               $('#bank_id').append("<option hidden='' disabled='disabled' selected='selected' value=''>Select Bank</option>");
                ...
                console.log(item1);
               $('#bank_id').append("<option value="+item1.bank.bank_id+">"+item1.bank.bank_name+"</option>");
            });
                });
                }
