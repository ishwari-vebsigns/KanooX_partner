...
@section('content')
        ...
        <section class="breadcrumb-area">
            <div class="breadcrumb-area-bg" style="background-image: url(web-assets/images/backgrounds/breadcrumb-area-bg-5.jpg);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="sidebar-box-style2">
                            ...
                            <div class="single-sidebar-box-style1">
                                ...
                                <div class="card-types-box">
                                    <ul>
                                        <li class="active"><a href="cards-business.html">Business</a></li>
                                        <li><a href="cards-cashback.html">Cashback</a></li>
                            ...
                            <div class="sidebar-banner-box">
                                ...
                                <div class="logo-box">
                                    <a href="index.html">
                                        <img src="web-assets/images/resources/banner-logo-1.png" alt="">
                                    </a>
                                </div>
                                <h3>Apply for Credit<br> Card Online</h3>
                                <ul>
                    ...
                    <div class="col-xl-8">
                        <div class="cards-deails-content-box">
                            <div class="cards-deails-content-1">
                                ...
                                <div class="text">
                                    <p>Fail in their duty through weakness of will which is the same as saying through
                                        shrinking from toil and pain cases are perfectly simple and easy to distinguish.
                                        In a free hour, when our power of choice the claims off duty or the obligations
                                        business it will frequently occur that pleasures.</p>
                                    <p>Through weakness of will which is the same as saying through shrinking from toil
                                        and pain cases are per-
                                        fectly simple and easy to distinguish in a free hour.</p>
                                </div>
                            </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="single-img-box">
                                                        <img src="web-assets/images/resources/card-details-1.jpg" alt="">
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="single-img-box">
                                                        <img src="web-assets/images/resources/card-details-2.jpg" alt="">
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="text-box">
                                            <ul>
                                                <li>
                                                    ...
                                                    <h3>Welcome Bonus</h3>
                                                    <p>Holds these matters principles selection
                                                        right some rejects.</p>
                                                </li>
                                                <li>
                                                    <span class="icon-shield-2"></span>
                                                    <h3>Accelerated Rewards</h3>
                                                    <p>Business will frequently occur that pleasure
                                                        have to be repudiated.</p>
                                                </li>
                                                <li>
                                                    <span class="icon-shield-2"></span>
                                                    <h3>Fuel Surcharge Waiver</h3>
                                                    <p>The wise man therefore always holds these
                            ...
                            <div class="card-details-features-box">
                                <div class="inner-title">
                                    <h2>Features</h2>
                                    <p>Same as saying through shrinking from toil and pain cases are perfectly simple
                                        and easy to distinguish. In a free hour, when our power of choice the claims off
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="card-details-single-features-box">
                                    ...
                                    <!--Start Card Details Single Features Box-->
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="card-details-single-features-box style2">
                                            <div class="single-benefits-box">
                                                <div class="icon">
                                    ...
                                    <!--Start Card Details Single Features Box-->
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="card-details-single-features-box style3">
                                            <div class="single-benefits-box">
                                                <div class="icon">
                                    ...
                                    <!--Start Card Details Single Features Box-->
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="card-details-single-features-box style4">
                                            <div class="single-benefits-box">
                                                <div class="icon">
                                ...
                                <div class="row">
                                        ...
                                        <div class="single-offer-box">
                                            <div class="top">
                                                <div class="offer-logo">
                                                    <img src="web-assets/images/resources/offer-logo-1.png" alt="">
                                                </div>
                                                <div class="date-box">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="single-offer-box">
                                            <div class="top">
                                                <div class="offer-logo">
                                                    <img src="web-assets/images/resources/offer-logo-2.png" alt="">
                                                </div>
                                                <div class="date-box">
                                        ...
                                        <div class="acc-content current">
                                            <div class="card-deatils-accordion-box-content">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Consider a credit score between 750 and 900 to be adequate for a
                                                        Credit Card.</li>
