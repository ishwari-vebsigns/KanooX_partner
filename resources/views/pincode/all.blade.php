...
<!--<link rel="stylesheet" href="{{$base_url}}/vendor/pickadate/themes/default.date.css">-->
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                <!--<a href="{{$base_url}}/admin/pincode/all">-->
                                    <a href="{{ url('admin/pincode/all') }}">
                                    All Pincode
                                </a>
                            </li>
                        </ol>
                ...
                <div class="row">
                 ...
                 <P></P>              <h4 class="card-title">
                    @if($my_permissions->contains('PINCODE_ADD'))
                    <a href="add" style="color:white;" class="btn btn-secondary">Add Pincode</a>
                    @endif
                    <button class="btn btn-primary" id="downloadButton">Download</button>
                    <a href="{{$base_url}}/admin/pincode/import/file-import" style="color:white;" class="btn btn-secondary">Import</a>
                            </div>
                            <div class="card-body">
 ...
 <script>
    ...
    //                 @if($my_permissions->contains('PINCODE_DETAILS'))
    //                     return '<a type="button" href="' + data.pincode_id + '" class="btn btn-dark">Details</a>'
    //                 @endif
    ...
    var table = $('#example').DataTable({
    processing: true,
    ajax: "{{ url('admin/pincode/allData') }}",
    order: [[0, 'desc']],
    columns: [
        { data: 'pincode_id' },
        { data: 'bank_name' },
        ...
        //     render: function(data, type, row){
        //         return `
        //             <a href="{{ url('admin/pincode/details') }}/${data}" 
