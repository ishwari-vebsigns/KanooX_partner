            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('admin/pincode/all') }}">Pincodes</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"> 
                                <div class="form-validation">
                                    ...
                                    <form action="{{ url('admin/pincode/add') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-10">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="form-control" id="val-skill" name="bank_id" value="{{old('bank_id')}}" required>
