            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{$base_url}}/admin/notification/all">All Notifications</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                 ...
                 <P></P>              <h4 class="card-title">
                    @if($my_permissions->contains('NOTIFICATION_ADD'))
                    <a href="add" style="color:white;" class="btn btn-secondary">Add Notification</a>
                    @endif
        ...
        columns: [
            ...
            { data: "title" },
            {
                ...
                render: function(data, type, row) {
                    if(data==1){
                        return '<span class="badge badge-warning">Alert</span>';

                    }
                    if(data==2){
                        return '<span class="badge badge-secondary">Information</span>';

                    }
                    if(data==3){
                        return '<span class="badge badge-danger">Emergancy</span>';

                    }
                    if(data==4){
                        return '<span class="badge badge-dark">Image</span>';
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    @if($my_permissions->contains('NOTIFICATION_DETAILS'))
                        return '<a type="button" href="' + data.notification_id + '" class="btn btn-dark">Details</a>'
                    @endif
