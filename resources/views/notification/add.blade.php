            ...
            <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Add New Notification</a></li>
                        </ol>
                    </div>
                </div>
                                            ...
                                            <div class="col-xl-10">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 {{ $errors->has('notification_name') ? ' has-error' : '' }}">
                                                        <input type="text" class="form-control" id="notification_name" name="notification_name" placeholder="Notification Title" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="form-control" id="val-skill" name="type" required>
